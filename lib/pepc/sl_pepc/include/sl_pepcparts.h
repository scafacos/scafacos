...
#define fcs_pepcparts_spec_elem_unset(_e_)          fcs_pepcparts_elem_null((_e_))
...
#define fcs_pepcparts_SPEC_DO_TPROCS_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ps_)  do { \
  ...
  for (spec2i.e = 0, spec2i.i = 0; spec2i.i < (_n_); ++spec2i.i) { \
    ...
    while (spec2i.j < spec2i.e) { \
      (_tp_)(fcs_pepcparts_spec_elem_get_buf(_b_), spec2i.j, (_tpd_), &spec2i.n, (_ps_)); \
      spec2i.o = -1; \
      while (spec2i.n > 0) { \
        --spec2i.n; \
...
#define fcs_pepcparts_SPEC_DO_TPROCS_MOD_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ps_, _ib_)  do { \
  ...
  for (spec3i.e = 0, spec3i.i = 0; spec3i.i < (_n_); ++spec3i.i) { \
    ...
    while (spec3i.j < spec3i.e) { \
      (_tp_)(fcs_pepcparts_spec_elem_get_buf(_b_), spec3i.j, (_tpd_), &spec3i.n, (_ps_), fcs_pepcparts_spec_elem_get_buf(_ib_)); \
      spec3i.o = -1; \
      while (spec3i.n > 0) { \
        --spec3i.n; \
...
/* sp_macro fcs_pepcparts_SPEC_DECLARE_TPROC_INDICES_DB */
#define fcs_pepcparts_SPEC_DECLARE_TPROC_INDICES_DB \
  struct { fcs_pepcparts_spec_elem_index_t i; fcs_pepcparts_spec_proc_t p; } spec0xd;

/* sp_macro fcs_pepcparts_SPEC_DO_TPROC_INDICES_DB */
#define fcs_pepcparts_SPEC_DO_TPROC_INDICES_DB(_tp_, _tpd_, _b_, _ix_, _id_)  do { \
  for (spec0xd.i = 0; spec0xd.i < fcs_pepcparts_spec_elem_get_n(_b_); ++spec0xd.i) { \
    spec0xd.p = (_tp_)(fcs_pepcparts_spec_elem_get_buf(_b_), spec0xd.i, (_tpd_)); \
    if (spec0xd.p == fcs_pepcparts_SPEC_PROC_NONE) continue; \
...
/* sp_macro fcs_pepcparts_SPEC_DECLARE_TPROCS_INDICES_DB */
#define fcs_pepcparts_SPEC_DECLARE_TPROCS_INDICES_DB \
  struct { fcs_pepcparts_spec_elem_index_t i; fcs_pepcparts_spec_int_t j, n; } spec2xd;

/* sp_macro fcs_pepcparts_SPEC_DO_TPROCS_INDICES_DB */
#define fcs_pepcparts_SPEC_DO_TPROCS_INDICES_DB(_tp_, _tpd_, _b_, _ix_, _id_, _ps_)  do { \
  for (spec2xd.i = 0; spec2xd.i < fcs_pepcparts_spec_elem_get_n(_b_); ++spec2xd.i) { \
    (_tp_)(fcs_pepcparts_spec_elem_get_buf(_b_), spec2xd.i, (_tpd_), &spec2xd.n, (_ps_)); \
...
#define fcs_pepcparts_SPLIT_GENERIC_INIT_TPROC(_tp_, _r_...)                  { 1, 0, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL,  NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL, _r_ }
#define fcs_pepcparts_SPLIT_GENERIC_INIT_EXT_TPROC(_tp_, _r_...)              { 1, 0, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROC(_tp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL, _r_ }
...
#define fcs_pepcparts_SPLIT_GENERIC_INIT_TPROC_MOD(_tp_, _r_...)              { 2, 0, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL,  NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL, _r_ }
#define fcs_pepcparts_SPLIT_GENERIC_INIT_EXT_TPROC_MOD(_tp_, _r_...)          { 2, 0, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD(_tp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL, _r_ }
...
#define fcs_pepcparts_SPLIT_GENERIC_INIT_TPROCS(_tp_, _xtp_, _r_...)          { 3, (_xtp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL,  NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL, _r_ }
#define fcs_pepcparts_SPLIT_GENERIC_INIT_EXT_TPROCS(_tp_, _xtp_, _r_...)      { 3, (_xtp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS(_tp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL, _r_ }
...
#define fcs_pepcparts_SPLIT_GENERIC_INIT_TPROCS_MOD(_tp_, _xtp_, _r_...)      { 4, (_xtp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define fcs_pepcparts_SPLIT_GENERIC_INIT_EXT_TPROCS_MOD(_tp_, _xtp_, _r_...)  { 4, (_xtp_), NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_NULL, _tp_, fcs_pepcparts_SPEC_EXT_PARAM_TPROCS_MOD(_tp_), _r_ }
...
typedef void fcs_pepcparts_tprocs_f(fcs_pepcparts_elements_t *b, fcs_pepcparts_slint_t x, void *tproc_data, fcs_pepcparts_slint_t *nprocs, int *procs);
typedef void fcs_pepcparts_tprocs_mod_f(fcs_pepcparts_elements_t *b, fcs_pepcparts_slint_t x, void *tproc_data, fcs_pepcparts_slint_t *nprocs, int *procs, fcs_pepcparts_elements_t *mod);
...
#ifdef SL_USE_MPI
/* sl_type fcs_pepcparts__sl_mpi_context_t fcs_pepcparts_sl_mpi_context_t */
typedef struct fcs_pepcparts__sl_mpi_context_t
{
  int size, rank;
  MPI_Comm comm;

} fcs_pepcparts_sl_mpi_context_t;
#endif


#ifdef SL_USE_OMP
/* sl_type fcs_pepcparts__sl_omp_context_t fcs_pepcparts_sl_omp_context_t */
typedef struct fcs_pepcparts__sl_omp_context_t
{
  int thread_num, num_threads, *coop_thread_nums;

} fcs_pepcparts_sl_omp_context_t;
#endif
...
fcs_pepcparts_slint_t SL_PROTO(fcs_pepcparts_sort_insert_kernel)(fcs_pepcparts_elements_t *s, fcs_pepcparts_elements_t *sx);
...
fcs_pepcparts_slint_t SL_PROTO(fcs_pepcparts_mpi_elements_sendrecv)(fcs_pepcparts_elements_t *sb, int sendcount, int dest, int sendtag, fcs_pepcparts_elements_t *rb, int recvcount, int recvtag, int source, fcs_pepcparts_slint_t *received, int size, int rank, MPI_Comm comm);
