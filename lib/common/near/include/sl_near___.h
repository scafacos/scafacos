...
typedef near____sl_int_type_c near____spint_t;

typedef near____spint_t near____spec_elem_index_t;
...
#define near____SPEC_PROC_NULL  MPI_PROC_NULL
...
/* sp_macro near____SPEC_PROC_NULL */
...
#define near____SPEC_DECLARE_TPROC_COUNT_DB \
  struct { near____spint_t i, p; } spec0cd;
...
#define near____SPEC_DO_TPROC_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec0cd.i = 0; spec0cd.i < near____spec_elem_get_n(_b_); ++spec0cd.i) { \
    ...
    if (spec0cd.p == near____SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec0cd.p]; \
  } } while (0)
...
#define near____SPEC_DECLARE_TPROC_COUNT_IP \
  struct { near____spint_t i, p, t; } spec0ci;
...
#define near____SPEC_DO_TPROC_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec0ci.i = 0; spec0ci.i < near____spec_elem_get_n(_b_); ++spec0ci.i) { \
    ...
    if (spec0ci.p == near____SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec0ci.p]; \
...
#define near____SPEC_DECLARE_TPROC_MOD_COUNT_DB \
  struct { near____spint_t i, p; } spec1cd;
...
#define near____SPEC_DO_TPROC_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec1cd.i = 0; spec1cd.i < near____spec_elem_get_n(_b_); ++spec1cd.i) { \
    ...
    if (spec1cd.p == near____SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec1cd.p]; \
  } } while (0)
...
#define near____SPEC_DECLARE_TPROC_MOD_COUNT_IP \
  struct { near____spint_t i, p, t; } spec1ci;
...
#define near____SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec1ci.i = 0; spec1ci.i < near____spec_elem_get_n(_b_); ++spec1ci.i) { \
    ...
    if (spec1ci.p == near____SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec1ci.p]; \
...
#define near____SPEC_DECLARE_TPROCS_COUNT_DB \
  struct { near____spint_t i, j, n; } spec2cd;
...
_s_ void _name_##_tprocs_count_db(near____spec_elem_t *s, near____spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_COUNT_IP \
  struct { near____spint_t i, j, n, t; } spec2ci;
...
_s_ void _name_##_tprocs_count_ip(near____spec_elem_t *s, near____spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_MOD_COUNT_DB \
  struct { near____spint_t i, j, n; } spec3cd;
...
_s_ void _name_##_tprocs_mod_count_db(near____spec_elem_t *s, near____spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_MOD_COUNT_IP \
  struct { near____spint_t i, j, n, t; } spec3ci;
...
_s_ void _name_##_tprocs_mod_count_ip(near____spec_elem_t *s, near____spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define near____SPEC_DECLARE_TPROC_REARRANGE_DB \
  struct { near____spint_t i, p; } spec0d;
...
#define near____SPEC_DO_TPROC_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_)  do { \
  for (spec0d.i = 0; spec0d.i < near____spec_elem_get_n(_sb_); ++spec0d.i) { \
    ...
    if (spec0d.p == near____SPEC_PROC_NULL) continue; \
...
#define near____SPEC_DECLARE_TPROC_REARRANGE_IP \
  struct { near____spint_t e, i, j, p, np; } spec0i;
...
_s_ void _name_##_tproc_rearrange_ip(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n) \
{ \
...
#define near____SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  struct { near____spint_t i, p; } spec1d;
...
#define near____SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ib_)  do { \
  if (_ib_) { \
    for (spec1d.i = 0; spec1d.i < near____spec_elem_get_n(_sb_); ++spec1d.i) { \
      ...
      if (spec1d.p == near____SPEC_PROC_NULL) continue; \
...
#define near____SPEC_DECLARE_TPROC_MOD_REARRANGE_IP \
  struct { near____spint_t e, i, j, p, np; } spec1i;
    ...
    for (spec1i.e = 0, spec1i.i = 0; spec1i.i < (_n_); ++spec1i.i) { \
      ...
      while (spec1i.j < spec1i.e) { \
        ...
        while (spec1i.p != spec1i.i) { \
          spec1i.np = (_tp_)(near____spec_elem_get_buf(_b_), (_ds_)[spec1i.p], _tpd_, (_ib_)); \
...
_s_ void _name_##_tproc_mod_rearrange_ip(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n, near____spec_elem_t *mod) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_REARRANGE_DB \
  struct { near____spint_t i, j, n; } spec2d;
...
_s_ void _name_##_tprocs_rearrange_db(near____spec_elem_t *s, near____spec_elem_t *d, near____spec_tproc_data_t tproc_data, int *displs, int *procs) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_REARRANGE_IP \
  struct { near____spint_t e, i, j, n, f, fe, fc, l, le, lc, o; } spec2i;
...
_s_ void _name_##_tprocs_rearrange_ip(near____spec_elem_t *s, near____spec_elem_t *d, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_MOD_REARRANGE_DB \
  struct { near____spint_t i, j, n; } spec3d;
...
_s_ void _name_##_tprocs_mod_rearrange_db(near____spec_elem_t *s, near____spec_elem_t *d, near____spec_tproc_data_t tproc_data, int *displs, int *procs, near____spec_elem_t *mod) \
{ \
...
#define near____SPEC_DECLARE_TPROCS_MOD_REARRANGE_IP \
  struct { near____spint_t e, i, j, n, o, f, fe, fc, l, le, lc; } spec3i;
...
_s_ void _name_##_tprocs_mod_rearrange_ip(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs, near____spec_elem_t *mod) \
{ \
...
typedef int near____spec_tproc_f(near____spec_elem_buf_t b, near____spec_elem_index_t x, near____spec_tproc_data_t tproc_data);
...
typedef void near____spec_tproc_rearrange_ip_f(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n);
...
typedef int near____spec_tproc_mod_f(near____spec_elem_buf_t b, near____spec_elem_index_t x, near____spec_tproc_data_t tproc_data, near____spec_elem_buf_t mod);
...
typedef void near____spec_tproc_mod_rearrange_ip_f(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n, near____spec_elem_t *mod);
...
typedef int near____spec_tprocs_f(near____spec_elem_buf_t b, near____spec_elem_index_t x, near____spec_tproc_data_t tproc_data, int *procs);
typedef void near____spec_tprocs_count_f(near____spec_elem_t *s, near____spec_tproc_data_t tproc_data, int *procs, int *counts);
typedef void near____spec_tprocs_rearrange_db_f(near____spec_elem_t *s, near____spec_elem_t *d, near____spec_tproc_data_t tproc_data, int *displs, int *procs);
typedef void near____spec_tprocs_rearrange_ip_f(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs);
...
typedef int near____spec_tprocs_mod_f(near____spec_elem_buf_t b, near____spec_elem_index_t x, near____spec_tproc_data_t tproc_data, int *procs, near____spec_elem_buf_t mod);
typedef void near____spec_tprocs_mod_count_f(near____spec_elem_t *s, near____spec_tproc_data_t tproc_data, int *procs, int *counts);
typedef void near____spec_tprocs_mod_rearrange_db_f(near____spec_elem_t *s, near____spec_elem_t *d, near____spec_tproc_data_t tproc_data, int *displs, int *procs, near____spec_elem_t *mod);
typedef void near____spec_tprocs_mod_rearrange_ip_f(near____spec_elem_t *s, near____spec_elem_t *x, near____spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs, near____spec_elem_t *mod);
...
typedef int near____tprocs_f(near____elements_t *b, near____slint_t x, void *tproc_data, int *procs);
typedef int near____tprocs_mod_f(near____elements_t *b, near____slint_t x, void *tproc_data, int *procs, near____elements_t *mod);
...
#define near____TPROC_EXDEF_DEFINE_TPROC(_name_, _tp_, _s_...) \
  ...
  const struct near_____tproc_exdef _##_name_ = { 1, near____SPEC_EXT_PARAM_TPROC(_name_), near____SPEC_EXT_PARAM_TPROC_MOD_NULL, near____SPEC_EXT_PARAM_TPROCS_NULL, near____SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define near____TPROC_EXDEF_DEFINE_TPROC_MOD(_name_, _tp_, _s_...) \
  near____SPEC_DEFINE_TPROC_MOD(_name_, _tp_, _s_) \
  const struct near_____tproc_exdef _##_name_ = { 2, near____SPEC_EXT_PARAM_TPROC_NULL, near____SPEC_EXT_PARAM_TPROC_MOD(_name_), near____SPEC_EXT_PARAM_TPROCS_NULL, near____SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define near____TPROC_EXDEF_DEFINE_TPROCS(_name_, _tp_, _s_...) \
  near____SPEC_DEFINE_TPROCS(_name_, _tp_, _s_) \
  const struct near_____tproc_exdef _##_name_ = { 3, near____SPEC_EXT_PARAM_TPROC_NULL, near____SPEC_EXT_PARAM_TPROC_MOD_NULL, near____SPEC_EXT_PARAM_TPROCS(_name_), near____SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define near____TPROC_EXDEF_DEFINE_TPROCS_MOD(_name_, _tp_, _s_...) \
  near____SPEC_DEFINE_TPROCS_MOD(_name_, _tp_, _s_) \
  const struct near_____tproc_exdef _##_name_ = { 4, near____SPEC_EXT_PARAM_TPROC_NULL, near____SPEC_EXT_PARAM_TPROC_MOD_NULL, near____SPEC_EXT_PARAM_TPROCS_NULL, near____SPEC_EXT_PARAM_TPROCS_MOD(_name_) }, *_name_ = &_##_name_;
...
near____slint_t SL_PROTO(near____split_generic_count)(near____elements_t *s, near____tproc_f tp, void *tp_data, int *counts);
near____slint_t SL_PROTO(near____split_generic_rearrange_ip)(near____elements_t *s, near____elements_t *sx, near____tproc_f tp, void *tp_data, int *displs, int *counts, int n);
