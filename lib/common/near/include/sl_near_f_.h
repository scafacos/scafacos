...
near_f__slint_t SL_PROTO(near_f__tproc_set_proclist)(near_f__tproc_t *tproc, near_f__slint_t nsend_procs, int *send_procs, near_f__slint_t nrecv_procs, int *recv_procs, int size, int rank, MPI_Comm comm);
