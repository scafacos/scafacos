...
back__p_slint_t SL_PROTO(back__p_mpi_elements_alltoallv_proclists_db)(back__p_elements_t *sbuf, int *scounts, int *sdispls, int nsendprocs, int *sendprocs, back__p_elements_t *rbuf, int *rcounts, int *rdispls, int nrecvprocs, int *recvprocs, int size, int rank, MPI_Comm comm);
...
back__p_slint_t SL_PROTO(back__p_mpi_mergek_sorted2)(back__p_elements_t *s, back__p_sortnet_f sn, back__p_sortnet_data_t snd, back__p_merge2x_f m2x, back__p_elements_t *xs, int size, int rank, MPI_Comm comm);
