...
/* sp_type spint_t spec_elem_index_t */
...
#ifdef SPEC_PROCLIST
void spec_make_recv_proclist(spint_t nsend_procs, int *send_procs, spint_t *nrecv_procs, int **recv_procs, int size, int rank, MPI_Comm comm);
spint_t spec_tproc_set_proclist(spec_tproc_t *tproc, spint_t nsend_procs, int *send_procs, spint_t nrecv_procs, int *recv_procs, int size, int rank, MPI_Comm comm);
#endif
