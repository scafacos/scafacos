...
/*
    fcs_float V = d->box_vector_a[0]*(d->box_vector_b[1] * d->box_vector_c[2] - d->box_vector_b[2] * d->box_vector_c[1])
            + d->box_vector_a[1]*(d->box_vector_b[2] * d->box_vector_c[0] - d->box_vector_b[0] * d->box_vector_c[2])
            + d->box_vector_a[2]*(d->box_vector_b[0] * d->box_vector_c[1] - d->box_vector_b[1] * d->box_vector_c[0]);
    P3M_INFO(printf("unit volume according to k vector calc = %f \n", V));
    fcs_float kn[3];
*/
