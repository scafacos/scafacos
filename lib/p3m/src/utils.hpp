...
namespace P3M {
  ...
  static inline p3m_float SQR(p3m_float x) { return x*x; }

  /** Calculates the pow(x,3) returning 'p3m_float'. */
  static inline p3m_float pow3(p3m_float x) { return x*x*x; }
  static inline p3m_int pow3i(p3m_int x) { return x*x*x; }
