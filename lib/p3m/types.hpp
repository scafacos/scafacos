...
#error Cannot use P3M_AD without P3M_INTERLACE
    ...
    const fcs_int P3M_MAX_GRID_DIFF = 10;
    /** This value for epsilon indicates metallic boundary conditions. */
    const fcs_float P3M_EPSILON_METALLIC = 0.0;
    /** precision limit for the r_cut zero */
    const fcs_float P3M_RCUT_PREC = 1.0e-3;
...
#ifdef P3M_INTERLACE
    const fcs_int P3M_BRILLOUIN = 1;
#else 
    const fcs_int P3M_BRILLOUIN = 0;
#endif
