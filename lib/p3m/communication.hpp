...
} ifcs_p3m_comm_struct;

void ifcs_p3m_comm_init(ifcs_p3m_comm_struct *comm, MPI_Comm communicator);
void ifcs_p3m_comm_prepare(ifcs_p3m_comm_struct *comm, fcs_float *box_l);
