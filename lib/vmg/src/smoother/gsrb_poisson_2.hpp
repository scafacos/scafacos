...
#ifndef GSRB_POISSON_2_HPP_
#define GSRB_POISSON_2_HPP_
...
class GaussSeidelRBPoisson2 : public Smoother
{
public:
  GaussSeidelRBPoisson2(bool register_ = true) :
    Smoother(register_)
  {}

  virtual ~GaussSeidelRBPoisson2() {}
