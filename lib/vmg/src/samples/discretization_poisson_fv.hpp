...
/**
 * @file   discretization_poisson_fv.hpp
...
#ifndef DISCRETIZATION_POISSON_FV_HPP_
#define DISCRETIZATION_POISSON_FV_HPP_
...
class DiscretizationPoissonFV : public Discretization
{
public:
  DiscretizationPoissonFV(const int& order) :
...
#endif /* DISCRETIZATION_POISSON_FV_HPP_ */
