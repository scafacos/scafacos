...
/**
 * @file   cycle_fas_periodic_debug.cpp
 * @author Julian Iseringhausen <isering@ins.uni-bonn.de>
 * @date   Wed Jun 27 14:48:42 2012
 *
 * @brief  Generates a FAS cycle for
 *         periodic boundary conditions with debug
 *         output.
 *
 */
...
#include "cycles/cycle_fas_periodic_debug.hpp"
#include "mg.hpp"

using namespace VMG;

void CycleFASPeriodicDebug::Generate()
{
