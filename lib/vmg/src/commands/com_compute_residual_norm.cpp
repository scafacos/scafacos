...
/**
 * @file   com_compute_residual_norm.cpp
...
class VMGCommandComputeResidualNorm : public Command
{
public:
  ...
  static const char* Name() {return "ComputeResidualNorm";}
  static int Arguments() {return 1;}
};

CREATE_INITIALIZER(VMGCommandComputeResidualNorm)
