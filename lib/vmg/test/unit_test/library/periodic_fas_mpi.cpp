...
struct LibraryPeriodicFASMPIFixture
{
  LibraryPeriodicFASMPIFixture()
  {
...
BOOST_FIXTURE_TEST_CASE(LibraryPeriodicFASMPITest, LibraryPeriodicFASMPIFixture)
{
  MG::Solve();
