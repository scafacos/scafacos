...
struct LibraryDirichletFASMPIFixture
{
  LibraryDirichletFASMPIFixture()
  {
...
BOOST_FIXTURE_TEST_CASE(LibraryDirichletFASMPITest, LibraryDirichletFASMPIFixture)
{
  MG::Solve();
