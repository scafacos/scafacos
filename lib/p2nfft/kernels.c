...
FCS_P2NFFT_KERNEL_TYPE ifcs_p2nfft_erfx_over_x(fcs_float r, fcs_int der, const fcs_float *param) /* K(x) = 1/x * erf(alpha*x) */
{
  ...
  fcs_float pow_der_1 = fcs_pow(r,-der-1);
  ...
  if (fcs_float_is_zero(pow_der_1)) {
    ...
    switch(der){
      ...
      case 0: return 1.1283791670955126; break;

      case 1: return 0.; break;

      case 2: return -0.752252778063675; break;

      case 3: return 0.; break;

      case 4: return 2.70811000102923; break;

      case 5: return 0.; break;

      case 6: return -19.3436428644945; break;

      case 7: return 0.; break;

      case 8: return 210.630777857829; break;

      case 9: return 0.; break;

      case 10: return -3102.0169102698455; break;

      case 11: return 0.; break;

      case 12: return 57745.2378681002; break;

      case 13: return 0.; break;

      case 14: return -1.3011926932945244e6; break;

      case 15: return 0.; break;

      case 16: return 3.444333599897271e7; break;

      case 17: return 0.; break;

      case 18: return -1.0478025372319065e9; break;

      case 19: return 0.; break;

      case 20: return 3.6024449137e10; break;
    ...
    switch(der){
      ...
      case 0: return fcs_erf(r)/r; break;

      case 1: poly = 1.1283791670955126/r; break;

      case 2: poly = (-2.256758334191025 - 2.256758334191025*r2)/r2; break;

      case 3: poly = (6.770275002573076 + r2*(4.51351666838205 + 4.51351666838205*r2))/fcs_pow(r,3); break;

      case 4: poly = (-27.081100010292303 + r2*(-18.0540666735282 + r2*(-4.51351666838205 - 9.0270333367641*r2)))/fcs_pow(r,4); break;

      case 5: poly = (135.4055000514615 + r2*(90.27033336764099 + r2*(36.1081333470564 + r2*(-9.0270333367641 + 18.0540666735282*r2))))/fcs_pow(r,5); break;

      case 6: poly = (-812.4330003087689 + r2*(-541.622000205846 + r2*(-216.64880008233843 + r2*(-81.24330003087691 + r2*(72.2162666941128 - 36.1081333470564*r2)))))/fcs_pow(r,6); break;

      case 7: poly = (5687.031002161382 + r2*(3791.3540014409214 + r2*(1516.5416005763689 + r2*(433.29760016467685 + r2*(306.9191334499794 + r2*(-288.8650667764512 + 72.2162666941128*r2))))))/fcs_pow(r,7); break;

      case 8: poly = (-45496.24801729106 + r2*(-30330.83201152737 + r2*(-12132.332804610951 + r2*(-3466.380801317415 + r2*(-559.6760668793743 + r2*(-1480.4334672293126 + r2*(938.8114670234664 - 144.4325333882256*r2)))))))/fcs_pow(r,8); break;

      case 9: poly = (409466.23215561954 + r2*(272977.4881037463 + r2*(109190.99524149856 + r2*(31197.42721185673 + r2*(6932.76160263483 + r2*(-1841.5148006998766 + r2*(6716.11280255249 + r2*(-2744.2181343762863 + 288.8650667764512*r2))))))))/fcs_pow(r,9); break;

      case 10: poly = (-4.0946623215561956e6 + r2*(-2.7297748810374634e6 + r2*(-1.0919099524149855e6 + r2*(-311974.2721185673 + r2*(-69327.61602634829 + r2*(-15707.038005969534 + r2*(23831.368009057227 + r2*(-27153.316276986414 + r2*(7510.4917361877315 - 577.7301335529024*r2)))))))))/fcs_pow(r,10); break;

      case 11: poly = (4.504128553711817e7 + r2*(3.0027523691412114e7 + r2*(1.2011009476564841e7 + r2*(3.4317169933042405e6 + r2*(762603.7762898313 + r2*(138655.23205269658 + r2*(79076.81203005352 + r2*(-156276.00112606012 + r2*(99369.58297109921 + r2*(-19642.824540798683 + 1155.4602671058049*r2))))))))))/fcs_pow(r,11); break;

      case 12: poly = (-5.404954264454178e8 + r2*(-3.6033028429694515e8 + r2*(-1.441321137187781e8 + r2*(-4.118060391965088e7 + r2*(-9.151245315477975e6 + r2*(-1.663862784632359e6 + r2*(-198233.65207533963 + r2*(-626981.6274382874 + r2*(809399.9171076163 + r2*(-336238.9377277892 + r2*(49684.791485549606 - 2310.9205342116097*r2)))))))))))/fcs_pow(r,12); break;

      case 13: poly = (7.026440543790431e9 + r2*(4.6842936958602915e9 + r2*(1.8737174783441153e9 + r2*(5.353478509554615e8 + r2*(1.1896618910121366e8 + r2*(2.1630216200220667e7 + r2*(3.327725569264718e6 + r2*(-857495.9507258955 + r2*(4.49156292330704e6 + r2*(-3.636233460581968e6 + r2*(1.0699562073399753e6 + r2*(-122478.78831321532 + 4621.841068423219*r2))))))))))))/fcs_pow(r,13); break;

      case 14: poly = (-9.837016761306606e10 + r2*(-6.558011174204404e10 + r2*(-2.6232044696817616e10 + r2*(-7.494869913376461e9 + r2*(-1.6655266474169915e9 + r2*(-3.028230268030893e8 + r2*(-4.658815796970605e7 + r2*(-7.512947089255331e6 + r2*(1.5189680671372911e7 + r2*(-2.7164293149523918e7 + r2*(1.4762160372543763e7 + r2*(-3.2422215094988886e6 + r2*(295797.82837908604 - 9243.682136846439*r2)))))))))))))/fcs_pow(r,14); break;

      case 15: poly = (1.4755525141959905e12 + r2*(9.837016761306603e11 + r2*(3.934806704522642e11 + r2*(1.1242304870064691e11 + r2*(2.498289971125487e10 + r2*(4.54234540204634e9 + r2*(6.988223695455908e8 + r2*(9.31763159394121e7 + r2*(4.5405255521256484e7 + r2*(-1.390365339408415e8 + r2*(1.4290154853431043e8 + r2*(-5.5462092821078636e7 + r2*(9.442421302788638e6 + r2*(-702519.8424003293 + 18487.364273692878*r2))))))))))))))/fcs_pow(r,15); break;

      case 16: poly = (-2.3608840227135848e13 + r2*(-1.5739226818090564e13 + r2*(-6.295690727236228e12 + r2*(-1.7987687792103506e12 + r2*(-3.9972639538007794e11 + r2*(-7.267752643274144e10 + r2*(-1.1181157912729452e10 + r2*(-1.4908210550305936e9 + r2*(-1.4094737635756773e8 + r2*(-5.0792011286503744e8 + r2*(9.92580810553235e8 + r2*(-6.740377468161713e8 + r2*(1.95905977367255e8 + r2*(-2.6612560871980898e7 + r2*(1.6453754203586662e6 - 36974.728547385756*r2)))))))))))))))/fcs_pow(r,16); break;

      case 17: poly = (4.013502838613095e14 + r2*(2.6756685590753966e14 + r2*(1.0702674236301586e14 + r2*(3.057906924657596e13 + r2*(6.795348721461325e12 + r2*(1.2355179493566045e12 + r2*(1.900796845164007e11 + r2*(2.5343957935520092e10 + r2*(2.9816421100611873e9 + r2*(-7.339454730149394e8 + r2*(4.986163467943015e9 + r2*(-6.029388102003498e9 + r2*(2.9153233125703826e9 + r2*(-6.57937563454319e8 + r2*(7.29696267882658e7 + r2*(-3.8083970403807326e6 + 73949.45709477151*r2))))))))))))))))/fcs_pow(r,17); break;

      case 18: poly = (-7.224305109503571e15 + r2*(-4.816203406335714e15 + r2*(-1.9264813625342855e15 + r2*(-5.504232464383673e14 + r2*(-1.2231627698630384e14 + r2*(-2.2239323088418883e13 + r2*(-3.4214343212952124e12 + r2*(-4.5619124283936163e11 + r2*(-5.366955798110137e10 + r2*(-6.697229693137314e9 + r2*(1.6426381349858925e10 + r2*(-4.011926744590352e10 + r2*(3.2466039391999672e10 + r2*(-1.1752084696229635e10 + r2*(2.1185410215795617e9 + r2*(-1.954484151014811e8 + r2*(8.726035937183037e6 - 147898.91418954302*r2)))))))))))))))))/fcs_pow(r,18); break;

      case 19: poly = (1.3726179708056784e17 + r2*(9.150786472037856e16 + r2*(3.660314588815142e16 + r2*(1.0458041682328978e16 + r2*(2.324009262739773e15 + r2*(4.2254713867995875e14 + r2*(6.500725210460904e13 + r2*(8.667633613947871e12 + r2*(1.019721601640926e12 + r2*(1.0733911596220274e11 + r2*(4.624722208599248e10 + r2*(-1.9332983248333194e11 + r2*(2.7503477124380505e11 + r2*(-1.5894875635383643e11 + r2*(4.468957960825489e10 + r2*(-6.582463024376897e9 + r2*(5.130613333235248e8 + r2*(-1.9818454501398765e7 + 295797.82837908604*r2))))))))))))))))))/fcs_pow(r,19); break;

      case 20: poly = (-2.745235941611356e18 + r2*(-1.8301572944075712e18 + r2*(-7.320629177630285e17 + r2*(-2.091608336465796e17 + r2*(-4.6480185254795464e16 + r2*(-8.450942773599175e15 + r2*(-1.3001450420921808e15 + r2*(-1.7335267227895744e14 + r2*(-2.039443203281852e13 + r2*(-2.146782319244055e12 + r2*(-1.6843100983841302e11 + r2*(-6.724839416219807e11 + r2*(1.7618335211856892e12 + r2*(-1.662710836964465e12 + r2*(7.201037291819669e11 + r2*(-1.6178625248465564e11 + r2*(1.9834723381959614e10 + r2*(-1.323399484168031e9 + r2*(4.4665472085241996e7 - 591595.6567581721*r2)))))))))))))))))))/fcs_pow(r,20); break;

      case 21: poly = (5.764995477383849e19 + r2*(3.8433303182558994e19 + r2*(1.5373321273023599e19 + r2*(4.392377506578171e18 + r2*(9.760838903507046e17 + r2*(1.7746979824558266e17 + r2*(2.7303045883935796e16 + r2*(3.640406117858106e15 + r2*(4.2828307268918894e14 + r2*(4.508242870412516e13 + r2*(4.29356463848811e12 + r2*(-1.0081058635671355e12 + r2*(8.392301967986719e12 + r2*(-1.349993206415817e13 + r2*(9.086251507384666e12 + r2*(-3.05806998321049e12 + r2*(5.615891855528267e11 + r2*(-5.819703954227166e10 + r2*(3.361446521699934e9 + r2*(-9.997966599213108e7 + 1.1831913135163442e6*r2))))))))))))))))))))/fcs_pow(r,21); break;

      default: return 0.0;

    }

    return poly * fcs_exp(-r2) + (der % 2 ? -1 : 1) * fak(der) * pow_der_1 * fcs_erf(r);
