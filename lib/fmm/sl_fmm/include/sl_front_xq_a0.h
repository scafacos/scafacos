...
typedef front_xq_a0_sl_int_type_c front_xq_a0_spint_t;

typedef front_xq_a0_spint_t front_xq_a0_spec_elem_index_t;
...
#define front_xq_a0_SPEC_PROC_NULL  MPI_PROC_NULL
...
/* sp_macro front_xq_a0_SPEC_PROC_NULL */
...
#define front_xq_a0_SPEC_DECLARE_TPROC_COUNT_DB \
  struct { front_xq_a0_spint_t i, p; } spec0cd;
...
#define front_xq_a0_SPEC_DO_TPROC_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec0cd.i = 0; spec0cd.i < front_xq_a0_spec_elem_get_n(_b_); ++spec0cd.i) { \
    ...
    if (spec0cd.p == front_xq_a0_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec0cd.p]; \
  } } while (0)
...
#define front_xq_a0_SPEC_DECLARE_TPROC_COUNT_IP \
  struct { front_xq_a0_spint_t i, p, t; } spec0ci;
...
#define front_xq_a0_SPEC_DO_TPROC_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec0ci.i = 0; spec0ci.i < front_xq_a0_spec_elem_get_n(_b_); ++spec0ci.i) { \
    ...
    if (spec0ci.p == front_xq_a0_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec0ci.p]; \
...
#define front_xq_a0_SPEC_DECLARE_TPROC_MOD_COUNT_DB \
  struct { front_xq_a0_spint_t i, p; } spec1cd;
...
#define front_xq_a0_SPEC_DO_TPROC_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec1cd.i = 0; spec1cd.i < front_xq_a0_spec_elem_get_n(_b_); ++spec1cd.i) { \
    ...
    if (spec1cd.p == front_xq_a0_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec1cd.p]; \
  } } while (0)
...
#define front_xq_a0_SPEC_DECLARE_TPROC_MOD_COUNT_IP \
  struct { front_xq_a0_spint_t i, p, t; } spec1ci;
...
#define front_xq_a0_SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec1ci.i = 0; spec1ci.i < front_xq_a0_spec_elem_get_n(_b_); ++spec1ci.i) { \
    ...
    if (spec1ci.p == front_xq_a0_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec1ci.p]; \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_COUNT_DB \
  struct { front_xq_a0_spint_t i, j, n; } spec2cd;
...
_s_ void _name_##_tprocs_count_db(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_COUNT_IP \
  struct { front_xq_a0_spint_t i, j, n, t; } spec2ci;
...
_s_ void _name_##_tprocs_count_ip(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_MOD_COUNT_DB \
  struct { front_xq_a0_spint_t i, j, n; } spec3cd;
...
_s_ void _name_##_tprocs_mod_count_db(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_MOD_COUNT_IP \
  struct { front_xq_a0_spint_t i, j, n, t; } spec3ci;
...
_s_ void _name_##_tprocs_mod_count_ip(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROC_REARRANGE_DB \
  struct { front_xq_a0_spint_t i, p; } spec0d;
...
#define front_xq_a0_SPEC_DO_TPROC_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_)  do { \
  for (spec0d.i = 0; spec0d.i < front_xq_a0_spec_elem_get_n(_sb_); ++spec0d.i) { \
    ...
    if (spec0d.p == front_xq_a0_SPEC_PROC_NULL) continue; \
...
#define front_xq_a0_SPEC_DECLARE_TPROC_REARRANGE_IP \
  struct { front_xq_a0_spint_t e, i, j, p, np; } spec0i;
...
_s_ void _name_##_tproc_rearrange_ip(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  struct { front_xq_a0_spint_t i, p; } spec1d;
...
#define front_xq_a0_SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ib_)  do { \
  if (_ib_) { \
    for (spec1d.i = 0; spec1d.i < front_xq_a0_spec_elem_get_n(_sb_); ++spec1d.i) { \
      ...
      if (spec1d.p == front_xq_a0_SPEC_PROC_NULL) continue; \
...
#define front_xq_a0_SPEC_DECLARE_TPROC_MOD_REARRANGE_IP \
  struct { front_xq_a0_spint_t e, i, j, p, np; } spec1i;
    ...
    for (spec1i.e = 0, spec1i.i = 0; spec1i.i < (_n_); ++spec1i.i) { \
      ...
      while (spec1i.j < spec1i.e) { \
        ...
        while (spec1i.p != spec1i.i) { \
          spec1i.np = (_tp_)(front_xq_a0_spec_elem_get_buf(_b_), (_ds_)[spec1i.p], _tpd_, (_ib_)); \
...
_s_ void _name_##_tproc_mod_rearrange_ip(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, front_xq_a0_spec_elem_t *mod) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_REARRANGE_DB \
  struct { front_xq_a0_spint_t i, j, n; } spec2d;
...
_s_ void _name_##_tprocs_rearrange_db(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *d, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *procs) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_REARRANGE_IP \
  struct { front_xq_a0_spint_t e, i, j, n, f, fe, fc, l, le, lc, o; } spec2i;
...
_s_ void _name_##_tprocs_rearrange_ip(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *d, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_MOD_REARRANGE_DB \
  struct { front_xq_a0_spint_t i, j, n; } spec3d;
...
_s_ void _name_##_tprocs_mod_rearrange_db(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *d, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *procs, front_xq_a0_spec_elem_t *mod) \
{ \
...
#define front_xq_a0_SPEC_DECLARE_TPROCS_MOD_REARRANGE_IP \
  struct { front_xq_a0_spint_t e, i, j, n, o, f, fe, fc, l, le, lc; } spec3i;
...
_s_ void _name_##_tprocs_mod_rearrange_ip(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs, front_xq_a0_spec_elem_t *mod) \
{ \
...
typedef int front_xq_a0_spec_tproc_f(front_xq_a0_spec_elem_buf_t b, front_xq_a0_spec_elem_index_t x, front_xq_a0_spec_tproc_data_t tproc_data);
...
typedef void front_xq_a0_spec_tproc_rearrange_ip_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n);
...
typedef int front_xq_a0_spec_tproc_mod_f(front_xq_a0_spec_elem_buf_t b, front_xq_a0_spec_elem_index_t x, front_xq_a0_spec_tproc_data_t tproc_data, front_xq_a0_spec_elem_buf_t mod);
...
typedef void front_xq_a0_spec_tproc_mod_rearrange_ip_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, front_xq_a0_spec_elem_t *mod);
...
typedef int front_xq_a0_spec_tprocs_f(front_xq_a0_spec_elem_buf_t b, front_xq_a0_spec_elem_index_t x, front_xq_a0_spec_tproc_data_t tproc_data, int *procs);
typedef void front_xq_a0_spec_tprocs_count_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_tproc_data_t tproc_data, int *procs, int *counts);
typedef void front_xq_a0_spec_tprocs_rearrange_db_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *d, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *procs);
typedef void front_xq_a0_spec_tprocs_rearrange_ip_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs);
...
typedef int front_xq_a0_spec_tprocs_mod_f(front_xq_a0_spec_elem_buf_t b, front_xq_a0_spec_elem_index_t x, front_xq_a0_spec_tproc_data_t tproc_data, int *procs, front_xq_a0_spec_elem_buf_t mod);
typedef void front_xq_a0_spec_tprocs_mod_count_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_tproc_data_t tproc_data, int *procs, int *counts);
typedef void front_xq_a0_spec_tprocs_mod_rearrange_db_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *d, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *procs, front_xq_a0_spec_elem_t *mod);
typedef void front_xq_a0_spec_tprocs_mod_rearrange_ip_f(front_xq_a0_spec_elem_t *s, front_xq_a0_spec_elem_t *x, front_xq_a0_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs, front_xq_a0_spec_elem_t *mod);
...
typedef int front_xq_a0_tprocs_f(front_xq_a0_elements_t *b, front_xq_a0_slint_t x, void *tproc_data, int *procs);
typedef int front_xq_a0_tprocs_mod_f(front_xq_a0_elements_t *b, front_xq_a0_slint_t x, void *tproc_data, int *procs, front_xq_a0_elements_t *mod);
...
#define front_xq_a0_TPROC_EXDEF_DEFINE_TPROC(_name_, _tp_, _s_...) \
  ...
  const struct front_xq_a0__tproc_exdef _##_name_ = { 1, front_xq_a0_SPEC_EXT_PARAM_TPROC(_name_), front_xq_a0_SPEC_EXT_PARAM_TPROC_MOD_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROCS_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define front_xq_a0_TPROC_EXDEF_DEFINE_TPROC_MOD(_name_, _tp_, _s_...) \
  front_xq_a0_SPEC_DEFINE_TPROC_MOD(_name_, _tp_, _s_) \
  const struct front_xq_a0__tproc_exdef _##_name_ = { 2, front_xq_a0_SPEC_EXT_PARAM_TPROC_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROC_MOD(_name_), front_xq_a0_SPEC_EXT_PARAM_TPROCS_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define front_xq_a0_TPROC_EXDEF_DEFINE_TPROCS(_name_, _tp_, _s_...) \
  front_xq_a0_SPEC_DEFINE_TPROCS(_name_, _tp_, _s_) \
  const struct front_xq_a0__tproc_exdef _##_name_ = { 3, front_xq_a0_SPEC_EXT_PARAM_TPROC_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROC_MOD_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROCS(_name_), front_xq_a0_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define front_xq_a0_TPROC_EXDEF_DEFINE_TPROCS_MOD(_name_, _tp_, _s_...) \
  front_xq_a0_SPEC_DEFINE_TPROCS_MOD(_name_, _tp_, _s_) \
  const struct front_xq_a0__tproc_exdef _##_name_ = { 4, front_xq_a0_SPEC_EXT_PARAM_TPROC_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROC_MOD_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROCS_NULL, front_xq_a0_SPEC_EXT_PARAM_TPROCS_MOD(_name_) }, *_name_ = &_##_name_;
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_split_generic_count)(front_xq_a0_elements_t *s, front_xq_a0_tproc_f tp, void *tp_data, int *counts);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_split_generic_rearrange_ip)(front_xq_a0_elements_t *s, front_xq_a0_elements_t *sx, front_xq_a0_tproc_f tp, void *tp_data, int *displs, int *counts, int n);
