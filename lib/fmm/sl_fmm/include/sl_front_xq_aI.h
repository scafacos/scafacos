...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROC_COUNT_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_proc_t p; } spec0cd;

/* sp_macro fcs_front_xq_aI_SPEC_DO_TPROC_COUNT_DB */
#define fcs_front_xq_aI_SPEC_DO_TPROC_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec0cd.i = 0; spec0cd.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec0cd.i) { \
...
_s_ void _name_##_tproc_count_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROC_COUNT_IP \
  struct { fcs_front_xq_aI_spec_elem_index_t i, t; fcs_front_xq_aI_spec_proc_t p; } spec0ci;

/* sp_macro fcs_front_xq_aI_SPEC_DO_TPROC_COUNT_IP */
#define fcs_front_xq_aI_SPEC_DO_TPROC_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  spec0ci.t = 0; \
  for (spec0ci.i = 0; spec0ci.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec0ci.i) { \
...
_s_ void _name_##_tproc_count_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROC_MOD_COUNT_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_proc_t p; } spec1cd;
...
#define fcs_front_xq_aI_SPEC_DO_TPROC_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec1cd.i = 0; spec1cd.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec1cd.i) { \
...
_s_ void _name_##_tproc_mod_count_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROC_MOD_COUNT_IP \
  struct { fcs_front_xq_aI_spec_elem_index_t i, t; fcs_front_xq_aI_spec_proc_t p; } spec1ci;
...
#define fcs_front_xq_aI_SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  spec1ci.t = 0; \
  for (spec1ci.i = 0; spec1ci.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec1ci.i) { \
...
_s_ void _name_##_tproc_mod_count_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROCS_COUNT_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_int_t j, n; } spec2cd;
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_COUNT_DB(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  for (spec2cd.i = 0; spec2cd.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec2cd.i) { \
    spec2cd.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec2cd.i, (_tpd_), (_ps_)); \
...
_s_ void _name_##_tprocs_count_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROCS_COUNT_IP \
  struct { fcs_front_xq_aI_spec_elem_index_t i, t; fcs_front_xq_aI_spec_int_t j, n; } spec2ci;
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_COUNT_IP(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  spec2ci.t = 0; \
  for (spec2ci.i = 0; spec2ci.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec2ci.i) { \
    spec2ci.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec2ci.i, (_tpd_), (_ps_)); \
...
_s_ void _name_##_tprocs_count_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROCS_MOD_COUNT_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_int_t j, n; } spec3cd;
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  for (spec3cd.i = 0; spec3cd.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec3cd.i) \
  { \
    spec3cd.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec3cd.i, (_tpd_), (_ps_), NULL); \
...
_s_ void _name_##_tprocs_mod_count_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROCS_MOD_COUNT_IP \
  struct { fcs_front_xq_aI_spec_elem_index_t i, t; fcs_front_xq_aI_spec_int_t j, n; } spec3ci;
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  spec3ci.t = 0; \
  for (spec3ci.i = 0; spec3ci.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec3ci.i) { \
    spec3ci.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec3ci.i, (_tpd_), (_ps_), NULL); \
...
_s_ void _name_##_tprocs_mod_count_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROC_REARRANGE_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_proc_t p; } spec0d;

/* sp_macro fcs_front_xq_aI_SPEC_DO_TPROC_REARRANGE_DB */
#define fcs_front_xq_aI_SPEC_DO_TPROC_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_)  do { \
  for (spec0d.i = 0; spec0d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec0d.i) { \
    ...
    fcs_front_xq_aI_spec_elem_copy_at((_sb_), spec0d.i, (_db_), (_ds_)[spec0d.p]); \
    ++(_ds_)[spec0d.p]; \
  } } while (0)

/* sp_macro fcs_front_xq_aI_SPEC_FUNC_TPROC_REARRANGE_DB */
#define fcs_front_xq_aI_SPEC_FUNC_TPROC_REARRANGE_DB(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_rearrange_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs) \
{ \
  fcs_front_xq_aI_SPEC_DECLARE_TPROC_REARRANGE_DB \
  fcs_front_xq_aI_SPEC_DO_TPROC_REARRANGE_DB(_tp_, tproc_data, s, d, displs); \
}
...
_s_ void _name_##_tproc_rearrange_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_proc_t p; } spec1d;

/* sp_macro fcs_front_xq_aI_SPEC_DO_TPROC_MOD_REARRANGE_DB */
#define fcs_front_xq_aI_SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ib_)  do { \
  if (_ib_) { \
    for (spec1d.i = 0; spec1d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec1d.i) { \
      ...
      fcs_front_xq_aI_spec_elem_copy_at((_ib_), 0, (_db_), (_ds_)[spec1d.p]); \
      ++(_ds_)[spec1d.p]; \
    } \
  } else { \
    for (spec1d.i = 0; spec1d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec1d.i) { \
      spec1d.p = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_sb_), spec1d.i, _tpd_, NULL); \
      if (spec1d.p == fcs_front_xq_aI_SPEC_PROC_NONE) continue; \
      fcs_front_xq_aI_spec_elem_copy_at((_sb_), spec1d.i, (_db_), (_ds_)[spec1d.p]); \
      ++(_ds_)[spec1d.p]; \
    } \
  } } while (0)
...
_s_ void _name_##_tproc_mod_rearrange_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, fcs_front_xq_aI_spec_elem_t *mod) \
{ \
  fcs_front_xq_aI_SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  fcs_front_xq_aI_SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, tproc_data, s, d, displs, mod); \
}
...
#define fcs_front_xq_aI_SPEC_DO_TPROC_MOD_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ib_)  do { \
  if (_ib_) { \
    ...
    for (spec1i.e = 0, spec1i.i = 0; spec1i.i < (_n_); ++spec1i.i) { \
      ...
      spec1i.j = (_ds_)[spec1i.i]; \
      while (spec1i.j < spec1i.e) { \
        spec1i.p = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec1i.j, _tpd_, NULL); \
        while (spec1i.p != spec1i.i) { \
          spec1i.np = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), (_ds_)[spec1i.p], _tpd_, NULL); \
          if (spec1i.np != spec1i.p) fcs_front_xq_aI_spec_elem_exchange_at((_b_), (_ds_)[spec1i.p], (_b_), spec1i.j, (_xb_)); \
          ++(_ds_)[spec1i.p]; \
          spec1i.p = spec1i.np; \
        } \
        ++spec1i.j; \
...
_s_ void _name_##_tproc_mod_rearrange_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n, fcs_front_xq_aI_spec_elem_t *mod) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROCS_REARRANGE_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_int_t j, n; } spec2d;

/* sp_macro fcs_front_xq_aI_SPEC_DO_TPROCS_REARRANGE_DB */
#define fcs_front_xq_aI_SPEC_DO_TPROCS_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ps_)  do { \
  for (spec2d.i = 0; spec2d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec2d.i) { \
    spec2d.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_sb_), spec2d.i, (_tpd_), (_ps_)); \
    for (spec2d.j = 0; spec2d.j < spec2d.n; ++spec2d.j) { \
      fcs_front_xq_aI_spec_elem_copy_at((_sb_), spec2d.i, (_db_), (_ds_)[(_ps_)[spec2d.j]]); \
      ++(_ds_)[(_ps_)[spec2d.j]]; \
    } \
  } } while (0)
...
_s_ void _name_##_tprocs_rearrange_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
  fcs_front_xq_aI_SPEC_DECLARE_TPROCS_REARRANGE_DB \
  fcs_front_xq_aI_SPEC_DO_TPROCS_REARRANGE_DB(_tp_, tproc_data, s, d, displs, procs); \
}
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ps_)  do { \
  ...
  for (spec2i.e = 0, spec2i.i = 0; spec2i.i < (_n_); ++spec2i.i) { \
    ...
    while (spec2i.j < spec2i.e) { \
      spec2i.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec2i.j, (_tpd_), (_ps_)); \
      spec2i.o = -1; \
      while (spec2i.n > 0) { \
        --spec2i.n; \
...
_s_ void _name_##_tprocs_rearrange_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
...
#define fcs_front_xq_aI_SPEC_DECLARE_TPROCS_MOD_REARRANGE_DB \
  struct { fcs_front_xq_aI_spec_elem_index_t i; fcs_front_xq_aI_spec_int_t j, n; } spec3d;

/* sp_macro fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_REARRANGE_DB */
#define fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ps_, _ib_)  do { \
  if (_ib_) { \
    for (spec3d.i = 0; spec3d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec3d.i) { \
      spec3d.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_sb_), spec3d.i, (_tpd_), (_ps_), fcs_front_xq_aI_spec_elem_get_buf(_ib_)); \
      for (spec3d.j = 0; spec3d.j < spec3d.n; ++spec3d.j) { \
        fcs_front_xq_aI_spec_elem_copy_at((_ib_), spec3d.j, (_db_), (_ds_)[(_ps_)[spec3d.j]]); \
        ++(_ds_)[(_ps_)[spec3d.j]]; \
      } \
    } \
  } else { \
    for (spec3d.i = 0; spec3d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec3d.i) { \
      spec3d.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_sb_), spec3d.i, (_tpd_), (_ps_), NULL); \
      for (spec3d.j = 0; spec3d.j < spec3d.n; ++spec3d.j) { \
        fcs_front_xq_aI_spec_elem_copy_at((_sb_), spec3d.i, (_db_), (_ds_)[(_ps_)[spec3d.j]]); \
        ++(_ds_)[(_ps_)[spec3d.j]]; \
      } \
    } \
  } } while (0)
...
_s_ void _name_##_tprocs_mod_rearrange_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, fcs_front_xq_aI_spec_proc_t *procs, fcs_front_xq_aI_spec_elem_t *mod) \
{ \
  fcs_front_xq_aI_SPEC_DECLARE_TPROCS_MOD_REARRANGE_DB \
  fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_REARRANGE_DB(_tp_, tproc_data, s, d, displs, procs, mod); \
}
  ...
  if (_ib_) { \
    ...
    for (spec3i.e = 0, spec3i.i = 0; spec3i.i < (_n_); ++spec3i.i) { \
      ...
      while (spec3i.j < spec3i.e) { \
        spec3i.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec3i.j, (_tpd_), (_ps_), fcs_front_xq_aI_spec_elem_get_buf(_ib_)); \
        spec3i.o = -1; \
        while (spec3i.n > 0) { \
          --spec3i.n; \
    ...
    for (spec3i.e = 0, spec3i.i = 0; spec3i.i < (_n_); ++spec3i.i) { \
      ...
      spec3i.j = (_ds_)[spec3i.i]; \
      while (spec3i.j < spec3i.e) { \
        spec3i.n = (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec3i.j, (_tpd_), (_ps_), NULL); \
        spec3i.o = -1; \
        while (spec3i.n > 0) { \
          --spec3i.n; \
          if ((_ps_)[spec3i.n] == spec3i.i && spec3i.o < 0) spec3i.o = spec3i.n; \
          ...
          if (spec3i.j != (_ds_)[(_ps_)[spec3i.n]]) fcs_front_xq_aI_spec_elem_copy_at((_b_), spec3i.j, (_b_), (_ds_)[(_ps_)[spec3i.n]]); \
          ++(_ds_)[(_ps_)[spec3i.n]]; \
          while (spec3i.f + 1 < (_n_) && spec3i.fc >= spec3i.fe) { ++spec3i.f; spec3i.fe += (_cs_)[spec3i.f]; spec3i.fc = (_ds_)[spec3i.f]; } \
        } \
        if (spec3i.o < 0) { \
...
_s_ void _name_##_tprocs_mod_rearrange_ip(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n, fcs_front_xq_aI_spec_proc_t *procs, fcs_front_xq_aI_spec_elem_t *mod) \
{ \
...
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC(_name_)       _name_##_tproc_count_db, _name_##_tproc_count_ip, _name_##_tproc_rearrange_db, _name_##_tproc_rearrange_ip
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL          NULL, NULL, NULL, NULL
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD(_name_)   _name_##_tproc_mod_count_db, _name_##_tproc_mod_count_ip, _name_##_tproc_mod_rearrange_db, _name_##_tproc_mod_rearrange_ip
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL      NULL, NULL, NULL, NULL
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS(_name_)      _name_##_tprocs_count_db, _name_##_tprocs_count_ip, _name_##_tprocs_rearrange_db, _name_##_tprocs_rearrange_ip
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL         NULL, NULL, NULL, NULL
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD(_name_)  _name_##_tprocs_mod_count_db, _name_##_tprocs_mod_count_ip, _name_##_tprocs_mod_rearrange_db, _name_##_tprocs_mod_rearrange_ip
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL     NULL, NULL, NULL, NULL


/* sp_type fcs_front_xq_aI_spec_tproc_f fcs_front_xq_aI_spec_tproc_count_f fcs_front_xq_aI_spec_tproc_rearrange_db_f fcs_front_xq_aI_spec_tproc_rearrange_ip_f */
...
typedef void fcs_front_xq_aI_spec_tproc_count_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts);
typedef void fcs_front_xq_aI_spec_tproc_rearrange_db_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs);
typedef void fcs_front_xq_aI_spec_tproc_rearrange_ip_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n);

/* sp_type fcs_front_xq_aI_spec_tproc_mod_f fcs_front_xq_aI_spec_tproc_mod_count_f fcs_front_xq_aI_spec_tproc_mod_rearrange_db_f fcs_front_xq_aI_spec_tproc_mod_rearrange_ip_f */
...
typedef void fcs_front_xq_aI_spec_tproc_mod_count_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts);
typedef void fcs_front_xq_aI_spec_tproc_mod_rearrange_db_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, fcs_front_xq_aI_spec_elem_t *mod);
typedef void fcs_front_xq_aI_spec_tproc_mod_rearrange_ip_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n, fcs_front_xq_aI_spec_elem_t *mod);

/* sp_type fcs_front_xq_aI_spec_tprocs_f fcs_front_xq_aI_spec_tprocs_count_f fcs_front_xq_aI_spec_tprocs_rearrange_db_f fcs_front_xq_aI_spec_tprocs_rearrange_ip_f */
typedef fcs_front_xq_aI_spec_int_t fcs_front_xq_aI_spec_tprocs_f(fcs_front_xq_aI_spec_elem_buf_t b, fcs_front_xq_aI_spec_elem_index_t x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, fcs_front_xq_aI_spec_proc_t *procs);
typedef void fcs_front_xq_aI_spec_tprocs_count_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts, fcs_front_xq_aI_spec_proc_t *procs);
typedef void fcs_front_xq_aI_spec_tprocs_rearrange_db_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, fcs_front_xq_aI_spec_proc_t *procs);
typedef void fcs_front_xq_aI_spec_tprocs_rearrange_ip_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n, fcs_front_xq_aI_spec_proc_t *procs);

/* sp_type fcs_front_xq_aI_spec_tprocs_mod_f fcs_front_xq_aI_spec_tprocs_mod_count_f fcs_front_xq_aI_spec_tprocs_mod_rearrange_db_f fcs_front_xq_aI_spec_tprocs_mod_rearrange_ip_f */
typedef fcs_front_xq_aI_spec_int_t fcs_front_xq_aI_spec_tprocs_mod_f(fcs_front_xq_aI_spec_elem_buf_t b, fcs_front_xq_aI_spec_elem_index_t x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, fcs_front_xq_aI_spec_proc_t *procs, fcs_front_xq_aI_spec_elem_buf_t mod);
typedef void fcs_front_xq_aI_spec_tprocs_mod_count_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *counts, fcs_front_xq_aI_spec_proc_t *procs);
typedef void fcs_front_xq_aI_spec_tprocs_mod_rearrange_db_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, fcs_front_xq_aI_spec_proc_t *procs, fcs_front_xq_aI_spec_elem_t *mod);
typedef void fcs_front_xq_aI_spec_tprocs_mod_rearrange_ip_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *x, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *displs, int *counts, fcs_front_xq_aI_spec_int_t n, fcs_front_xq_aI_spec_proc_t *procs, fcs_front_xq_aI_spec_elem_t *mod);
...
_s_ void _name_##_tloc_rearrange_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_elem_t *d, fcs_front_xq_aI_spec_tloc_data_t tloc_data) \
{ \
...
typedef struct fcs_front_xq_aI__split_generic_t
{
  ...
  fcs_front_xq_aI_spec_tproc_count_f *tproc_count_db, *tproc_count_ip;
  fcs_front_xq_aI_spec_tproc_rearrange_db_f *tproc_rearrange_db;
  fcs_front_xq_aI_spec_tproc_rearrange_ip_f *tproc_rearrange_ip;

  fcs_front_xq_aI_spec_tproc_mod_f *tproc_mod;
  fcs_front_xq_aI_spec_tproc_mod_count_f *tproc_mod_count_db, *tproc_mod_count_ip;
  fcs_front_xq_aI_spec_tproc_mod_rearrange_db_f *tproc_mod_rearrange_db;
  fcs_front_xq_aI_spec_tproc_mod_rearrange_ip_f *tproc_mod_rearrange_ip;

  fcs_front_xq_aI_spec_tprocs_f *tprocs;
  fcs_front_xq_aI_spec_tprocs_count_f *tprocs_count_db, *tprocs_count_ip;
  fcs_front_xq_aI_spec_tprocs_rearrange_db_f *tprocs_rearrange_db;
  fcs_front_xq_aI_spec_tprocs_rearrange_ip_f *tprocs_rearrange_ip;

  fcs_front_xq_aI_spec_tprocs_mod_f *tprocs_mod;
  fcs_front_xq_aI_spec_tprocs_mod_count_f *tprocs_mod_count_db, *tprocs_mod_count_ip;
  fcs_front_xq_aI_spec_tprocs_mod_rearrange_db_f *tprocs_mod_rearrange_db;
  fcs_front_xq_aI_spec_tprocs_mod_rearrange_ip_f *tprocs_mod_rearrange_ip;
...
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_TPROC(_tp_, _r_...)           { 1, _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL,  NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_EXT_TPROC(_tp_, _r_...)       { 1, _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC(_tp_), NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
...
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_TPROC_MOD(_tp_, _r_...)       { 2, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL, _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL,  NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_EXT_TPROC_MOD(_tp_, _r_...)   { 2, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL, _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD(_tp_), NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
...
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_TPROCS(_tp_, _r_...)          { 3, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL, _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL,  NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_EXT_TPROCS(_tp_, _r_...)      { 3, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL, _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS(_tp_), NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
...
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_TPROCS_MOD(_tp_, _r_...)      { 4, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL,  _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define fcs_front_xq_aI_SPLIT_GENERIC_INIT_EXT_TPROCS_MOD(_tp_, _r_...)  { 4, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_NULL,  _tp_, fcs_front_xq_aI_SPEC_EXT_PARAM_TPROCS_MOD(_tp_), _r_ }
...
typedef fcs_front_xq_aI_slint_t fcs_front_xq_aI_tprocs_f(fcs_front_xq_aI_elements_t *b, fcs_front_xq_aI_slint_t x, void *tproc_data, int *procs);
typedef fcs_front_xq_aI_slint_t fcs_front_xq_aI_tprocs_mod_f(fcs_front_xq_aI_elements_t *b, fcs_front_xq_aI_slint_t x, void *tproc_data, int *procs, fcs_front_xq_aI_elements_t *mod);
...
/* sl_type fcs_front_xq_aI__tproc_t fcs_front_xq_aI_tproc_t */
typedef struct fcs_front_xq_aI__tproc_t *fcs_front_xq_aI_tproc_t;
...
#if defined(elem_weight) && defined(fcs_front_xq_aI_sl_weight_intequiv)
...
fcs_front_xq_aI_slint_t sendrecv_replace_mpi_maxsize;
  ...
  struct {
double t[2];
fcs_front_xq_aI_slint_t max_nprocs;
...
extern const fcs_front_xq_aI_slint_t fcs_front_xq_aI_default_meas_max_nprocs;
...
fcs_front_xq_aI_slint_t SL_PROTO(fcs_front_xq_aI_tproc_create_tprocs)(fcs_front_xq_aI_tproc_t *tproc, fcs_front_xq_aI_tprocs_f *tfn, fcs_front_xq_aI_tproc_reset_f *rfn, fcs_front_xq_aI_tproc_exdef exdef);
fcs_front_xq_aI_slint_t SL_PROTO(fcs_front_xq_aI_tproc_create_tprocs_mod)(fcs_front_xq_aI_tproc_t *tproc, fcs_front_xq_aI_tprocs_mod_f *tfn, fcs_front_xq_aI_tproc_reset_f *rfn, fcs_front_xq_aI_tproc_exdef exdef);
