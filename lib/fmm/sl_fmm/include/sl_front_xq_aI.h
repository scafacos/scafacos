...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_COUNT_DB(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  for (spec2cd.i = 0; spec2cd.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec2cd.i) { \
    (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec2cd.i, (_tpd_), &spec2cd.n, (_ps_)); \
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_COUNT_IP(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  ...
  for (spec2ci.i = 0; spec2ci.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec2ci.i) { \
    (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec2ci.i, (_tpd_), &spec2ci.n, (_ps_)); \
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  for (spec3cd.i = 0; spec3cd.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec3cd.i) { \
    (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec3cd.i, (_tpd_), &spec3cd.n, (_ps_), NULL); \
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  ...
  for (spec3ci.i = 0; spec3ci.i < fcs_front_xq_aI_spec_elem_get_n(_b_); ++spec3ci.i) { \
    (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_b_), spec3ci.i, (_tpd_), &spec3ci.n, (_ps_), NULL); \
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ps_)  do { \
  for (spec2d.i = 0; spec2d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec2d.i) { \
    (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_sb_), spec2d.i, (_tpd_), &spec2d.n, (_ps_)); \
...
#define fcs_front_xq_aI_SPEC_DO_TPROCS_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ps_, _ib_)  do { \
  for (spec3d.i = 0; spec3d.i < fcs_front_xq_aI_spec_elem_get_n(_sb_); ++spec3d.i) { \
    (_tp_)(fcs_front_xq_aI_spec_elem_get_buf(_sb_), spec3d.i, (_tpd_), &spec3d.n, (_ps_), fcs_front_xq_aI_spec_elem_get_buf(_ib_)); \
...
_s_ void _name_##_tproc_indices_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *indices, int *idispls) \
{ \
...
_s_ void _name_##_tprocs_indices_db(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *indices, int *idispls, fcs_front_xq_aI_spec_proc_t *procs) \
{ \
...
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC(_name_)       _name_##_tproc_count_db, _name_##_tproc_count_ip, _name_##_tproc_rearrange_db, _name_##_tproc_rearrange_ip, _name_##_tproc_indices_db
#define fcs_front_xq_aI_SPEC_EXT_PARAM_TPROC_NULL          NULL, NULL, NULL, NULL, NULL
...
/* sp_type fcs_front_xq_aI_spec_tproc_f fcs_front_xq_aI_spec_tproc_count_f fcs_front_xq_aI_spec_tproc_rearrange_db_f fcs_front_xq_aI_spec_tproc_rearrange_ip_f fcs_front_xq_aI_spec_tproc_indices_db_f */
...
typedef void fcs_front_xq_aI_spec_tproc_indices_db_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *indices, int *idispls);
...
typedef void fcs_front_xq_aI_spec_tprocs_indices_db_f(fcs_front_xq_aI_spec_elem_t *s, fcs_front_xq_aI_spec_tproc_data_t tproc_data, int *indices, int *idispls, fcs_front_xq_aI_spec_proc_t *procs);
...
typedef struct fcs_front_xq_aI__split_generic_t
{
  ...
  fcs_front_xq_aI_spec_tproc_indices_db_f *tproc_indices_db;
  ...
  fcs_front_xq_aI_spec_tprocs_indices_db_f *tprocs_indices_db;
