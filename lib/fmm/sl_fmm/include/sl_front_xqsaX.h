...
#define front_xqsaX_SPEC_TLOC

typedef front_xqsaX_sl_int_type_c front_xqsaX_spec_int_t;

typedef int front_xqsaX_spec_proc_t;

#define front_xqsaX_SPEC_LOC_NONE   -1
#ifdef SL_USE_MPI
# define front_xqsaX_SPEC_PROC_NONE  MPI_PROC_NULL
#else
# define front_xqsaX_SPEC_PROC_NONE  -1
#endif

typedef void *front_xqsaX_spec_tloc_data_t;
...
typedef front_xqsaX_sl_int_type_c front_xqsaX_spec_elem_index_t;
...
#define front_xqsaX_SPEC_DECLARE_TPROC_COUNT_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_proc_t p; } spec0cd;
...
#define front_xqsaX_SPEC_DO_TPROC_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec0cd.i = 0; spec0cd.i < front_xqsaX_spec_elem_get_n(_b_); ++spec0cd.i) { \
    ...
    if (spec0cd.p == front_xqsaX_SPEC_PROC_NONE) continue; \
    ++(_cs_)[spec0cd.p]; \
  } } while (0)
...
#define front_xqsaX_SPEC_DECLARE_TPROC_COUNT_IP \
  struct { front_xqsaX_spec_elem_index_t i, t; front_xqsaX_spec_proc_t p; } spec0ci;
...
#define front_xqsaX_SPEC_DO_TPROC_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec0ci.i = 0; spec0ci.i < front_xqsaX_spec_elem_get_n(_b_); ++spec0ci.i) { \
    ...
    if (spec0ci.p == front_xqsaX_SPEC_PROC_NONE) continue; \
    ++(_cs_)[spec0ci.p]; \
...
#define front_xqsaX_SPEC_DECLARE_TPROC_MOD_COUNT_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_proc_t p; } spec1cd;
...
#define front_xqsaX_SPEC_DO_TPROC_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec1cd.i = 0; spec1cd.i < front_xqsaX_spec_elem_get_n(_b_); ++spec1cd.i) { \
    ...
    if (spec1cd.p == front_xqsaX_SPEC_PROC_NONE) continue; \
    ++(_cs_)[spec1cd.p]; \
  } } while (0)
...
#define front_xqsaX_SPEC_DECLARE_TPROC_MOD_COUNT_IP \
  struct { front_xqsaX_spec_elem_index_t i, t; front_xqsaX_spec_proc_t p; } spec1ci;
...
#define front_xqsaX_SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec1ci.i = 0; spec1ci.i < front_xqsaX_spec_elem_get_n(_b_); ++spec1ci.i) { \
    ...
    if (spec1ci.p == front_xqsaX_SPEC_PROC_NONE) continue; \
    ++(_cs_)[spec1ci.p]; \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_COUNT_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_int_t j, n; } spec2cd;
...
_s_ void _name_##_tprocs_count_db(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_tproc_data_t tproc_data, int *counts, front_xqsaX_spec_proc_t *procs) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_COUNT_IP \
  struct { front_xqsaX_spec_elem_index_t i, t; front_xqsaX_spec_int_t j, n; } spec2ci;
...
_s_ void _name_##_tprocs_count_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_tproc_data_t tproc_data, int *counts, front_xqsaX_spec_proc_t *procs) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_MOD_COUNT_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_int_t j, n; } spec3cd;
...
_s_ void _name_##_tprocs_mod_count_db(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_tproc_data_t tproc_data, int *counts, front_xqsaX_spec_proc_t *procs) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_MOD_COUNT_IP \
  struct { front_xqsaX_spec_elem_index_t i, t; front_xqsaX_spec_int_t j, n; } spec3ci;
...
_s_ void _name_##_tprocs_mod_count_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_tproc_data_t tproc_data, int *counts, front_xqsaX_spec_proc_t *procs) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROC_REARRANGE_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_proc_t p; } spec0d;
...
#define front_xqsaX_SPEC_DO_TPROC_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_)  do { \
  for (spec0d.i = 0; spec0d.i < front_xqsaX_spec_elem_get_n(_sb_); ++spec0d.i) { \
    ...
    if (spec0d.p == front_xqsaX_SPEC_PROC_NONE) continue; \
...
#define front_xqsaX_SPEC_DECLARE_TPROC_REARRANGE_IP \
  struct { front_xqsaX_spec_elem_index_t e, i, j; front_xqsaX_spec_proc_t p, np; } spec0i;
...
_s_ void _name_##_tproc_rearrange_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_proc_t p; } spec1d;
...
#define front_xqsaX_SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ib_)  do { \
  if (_ib_) { \
    for (spec1d.i = 0; spec1d.i < front_xqsaX_spec_elem_get_n(_sb_); ++spec1d.i) { \
      ...
      if (spec1d.p == front_xqsaX_SPEC_PROC_NONE) continue; \
...
#define front_xqsaX_SPEC_DECLARE_TPROC_MOD_REARRANGE_IP \
  struct { front_xqsaX_spec_elem_index_t e, i, j; front_xqsaX_spec_proc_t p, np; } spec1i;
    ...
    for (spec1i.e = 0, spec1i.i = 0; spec1i.i < (_n_); ++spec1i.i) { \
      ...
      while (spec1i.j < spec1i.e) { \
        ...
        while (spec1i.p != spec1i.i) { \
          spec1i.np = (_tp_)(front_xqsaX_spec_elem_get_buf(_b_), (_ds_)[spec1i.p], _tpd_, front_xqsaX_spec_elem_get_buf(_ib_)); \
...
_s_ void _name_##_tproc_mod_rearrange_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n, front_xqsaX_spec_elem_t *mod) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_REARRANGE_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_int_t j, n; } spec2d;
...
_s_ void _name_##_tprocs_rearrange_db(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, front_xqsaX_spec_proc_t *procs) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_REARRANGE_IP \
  struct { front_xqsaX_spec_elem_index_t e, j, fe, fc, le, lc; front_xqsaX_spec_int_t i, n, f, l, o; } spec2i;
...
_s_ void _name_##_tprocs_rearrange_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n, front_xqsaX_spec_proc_t *procs) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_MOD_REARRANGE_DB \
  struct { front_xqsaX_spec_elem_index_t i; front_xqsaX_spec_int_t j, n; } spec3d;
...
_s_ void _name_##_tprocs_mod_rearrange_db(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, front_xqsaX_spec_proc_t *procs, front_xqsaX_spec_elem_t *mod) \
{ \
...
#define front_xqsaX_SPEC_DECLARE_TPROCS_MOD_REARRANGE_IP \
  struct { front_xqsaX_spec_elem_index_t e, j, fe, fc, le, lc; front_xqsaX_spec_int_t i, n, f, l, o; } spec3i;
...
_s_ void _name_##_tprocs_mod_rearrange_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n, front_xqsaX_spec_proc_t *procs, front_xqsaX_spec_elem_t *mod) \
{ \
...
typedef front_xqsaX_spec_proc_t front_xqsaX_spec_tproc_f(front_xqsaX_spec_elem_buf_t b, front_xqsaX_spec_elem_index_t x, front_xqsaX_spec_tproc_data_t tproc_data);
...
typedef void front_xqsaX_spec_tproc_rearrange_ip_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n);
...
typedef front_xqsaX_spec_proc_t front_xqsaX_spec_tproc_mod_f(front_xqsaX_spec_elem_buf_t b, front_xqsaX_spec_elem_index_t x, front_xqsaX_spec_tproc_data_t tproc_data, front_xqsaX_spec_elem_buf_t mod);
...
typedef void front_xqsaX_spec_tproc_mod_rearrange_ip_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n, front_xqsaX_spec_elem_t *mod);
...
typedef front_xqsaX_spec_int_t front_xqsaX_spec_tprocs_f(front_xqsaX_spec_elem_buf_t b, front_xqsaX_spec_elem_index_t x, front_xqsaX_spec_tproc_data_t tproc_data, front_xqsaX_spec_proc_t *procs);
typedef void front_xqsaX_spec_tprocs_count_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_tproc_data_t tproc_data, int *counts, front_xqsaX_spec_proc_t *procs);
typedef void front_xqsaX_spec_tprocs_rearrange_db_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, front_xqsaX_spec_proc_t *procs);
typedef void front_xqsaX_spec_tprocs_rearrange_ip_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n, front_xqsaX_spec_proc_t *procs);
...
typedef front_xqsaX_spec_int_t front_xqsaX_spec_tprocs_mod_f(front_xqsaX_spec_elem_buf_t b, front_xqsaX_spec_elem_index_t x, front_xqsaX_spec_tproc_data_t tproc_data, front_xqsaX_spec_proc_t *procs, front_xqsaX_spec_elem_buf_t mod);
typedef void front_xqsaX_spec_tprocs_mod_count_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_tproc_data_t tproc_data, int *counts, front_xqsaX_spec_proc_t *procs);
typedef void front_xqsaX_spec_tprocs_mod_rearrange_db_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, front_xqsaX_spec_proc_t *procs, front_xqsaX_spec_elem_t *mod);
typedef void front_xqsaX_spec_tprocs_mod_rearrange_ip_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tproc_data_t tproc_data, int *displs, int *counts, front_xqsaX_spec_int_t n, front_xqsaX_spec_proc_t *procs, front_xqsaX_spec_elem_t *mod);
...
#ifdef front_xqsaX_SPEC_TLOC

/* sp_macro front_xqsaX_SPEC_TLOC front_xqsaX_SPEC_LOC_NONE */


/* tloc rearrange */

/* sp_macro front_xqsaX_SPEC_DECLARE_TLOC_REARRANGE_DB */
#define front_xqsaX_SPEC_DECLARE_TLOC_REARRANGE_DB \
  struct { front_xqsaX_spec_int_t i, p; } spec0d;

/* sp_macro front_xqsaX_SPEC_DO_TLOC_REARRANGE_DB */
#define front_xqsaX_SPEC_DO_TLOC_REARRANGE_DB(_tl_, _tld_, _sb_, _db_)  do { \
  for (spec0d.i = 0; spec0d.i < front_xqsaX_spec_elem_get_n(_sb_); ++spec0d.i) { \
    spec0d.p = (_tl_)(front_xqsaX_spec_elem_get_buf(_sb_), spec0d.i, _tld_); \
    if (spec0d.p == front_xqsaX_SPEC_LOC_NONE) continue; \
    front_xqsaX_spec_elem_copy_at((_sb_), spec0d.i, (_db_), spec0d.p); \
  } } while (0)

/* sp_macro front_xqsaX_SPEC_FUNC_TLOC_REARRANGE_DB */
#define front_xqsaX_SPEC_FUNC_TLOC_REARRANGE_DB(_name_, _tl_, _s_...) \
_s_ void _name_##_tloc_rearrange_db(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tloc_data_t tloc_data) \
{ \
  front_xqsaX_SPEC_DECLARE_TLOC_REARRANGE_DB \
  front_xqsaX_SPEC_DO_TLOC_REARRANGE_DB(_tl_, tloc_data, s, d); \
}

/* sp_macro front_xqsaX_SPEC_DECLARE_TLOC_REARRANGE_IP */
#define front_xqsaX_SPEC_DECLARE_TLOC_REARRANGE_IP \
  struct { front_xqsaX_spec_int_t i, p, np; } spec0i;

/* sp_macro front_xqsaX_SPEC_DO_TLOC_REARRANGE_IP */
#define front_xqsaX_SPEC_DO_TLOC_REARRANGE_IP(_tl_, _tld_, _b_, _xb_)  do { \
  for (spec0i.i = 0; spec0i.i < front_xqsaX_spec_elem_get_n(_b_); ++spec0i.i) { \
    spec0i.p = (_tl_)(front_xqsaX_spec_elem_get_buf(_b_), spec0i.i, _tld_); \
    if (spec0i.p == front_xqsaX_SPEC_LOC_NONE) continue; \
    while (spec0i.i != spec0i.p) { \
      spec0i.np = (_tl_)(front_xqsaX_spec_elem_get_buf(_b_), spec0i.p, _tld_); \
      if (spec0i.np == front_xqsaX_SPEC_LOC_NONE) { front_xqsaX_spec_elem_copy_at((_b_), spec0i.i, (_b_), spec0i.p); break; } \
      front_xqsaX_spec_elem_exchange_at((_b_), spec0i.i, (_b_), spec0i.p, (_xb_)); \
      spec0i.p = spec0i.np; \
    } \
  } } while (0)

/* sp_macro front_xqsaX_SPEC_FUNC_TLOC_REARRANGE_IP */
#define front_xqsaX_SPEC_FUNC_TLOC_REARRANGE_IP(_name_, _tl_, _s_) \
_s_ void _name_##_tloc_rearrange_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tloc_data_t tloc_data) \
{ \
  front_xqsaX_SPEC_DECLARE_TLOC_REARRANGE_IP \
  front_xqsaX_SPEC_DO_TLOC_REARRANGE_IP(_tl_, tloc_data, s, x); \
}


/* tloc_mod_mod rearrange */

/* sp_macro front_xqsaX_SPEC_DECLARE_TLOC_MOD_REARRANGE_DB */
#define front_xqsaX_SPEC_DECLARE_TLOC_MOD_REARRANGE_DB \
  struct { front_xqsaX_spec_int_t i, p; } spec1d;

/* sp_macro front_xqsaX_SPEC_DO_TLOC_MOD_REARRANGE_DB */
#define front_xqsaX_SPEC_DO_TLOC_MOD_REARRANGE_DB(_tl_, _tld_, _sb_, _db_, _ib_)  do { \
  if (_ib_) { \
    for (spec1d.i = 0; spec1d.i < front_xqsaX_spec_elem_get_n(_sb_); ++spec1d.i) { \
      spec1d.p = (_tl_)(front_xqsaX_spec_elem_get_buf(_sb_), spec1d.i, _tld_, front_xqsaX_spec_elem_get_buf(_ib_)); \
      if (spec1d.p == front_xqsaX_SPEC_LOC_NONE) continue; \
      front_xqsaX_spec_elem_copy_at((_ib_), 0, (_db_), spec1d.p); \
    } \
  } else { \
    for (spec1d.i = 0; spec1d.i < front_xqsaX_spec_elem_get_n(_sb_); ++spec1d.i) { \
      spec1d.p = (_tl_)(front_xqsaX_spec_elem_get_buf(_sb_), spec1d.i, _tld_, NULL); \
      if (spec1d.p == front_xqsaX_SPEC_LOC_NONE) continue; \
      front_xqsaX_spec_elem_copy_at((_sb_), spec1d.i, (_db_), spec1d.p); \
    } \
  } } while (0) 

/* sp_macro front_xqsaX_SPEC_FUNC_TLOC_MOD_REARRANGE_DB */
#define front_xqsaX_SPEC_FUNC_TLOC_MOD_REARRANGE_DB(_name_, _tl_, _s_...) \
_s_ void _name_##_tloc_mod_rearrange_db(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tloc_data_t tloc_data, front_xqsaX_spec_elem_t *mod) \
{ \
  front_xqsaX_SPEC_DECLARE_TLOC_MOD_REARRANGE_DB \
  front_xqsaX_SPEC_DO_TLOC_MOD_REARRANGE_DB(_tl_, tloc_data, s, d, mod); \
}

/* sp_macro front_xqsaX_SPEC_DECLARE_TLOC_MOD_REARRANGE_IP */
#define front_xqsaX_SPEC_DECLARE_TLOC_MOD_REARRANGE_IP \
  struct { front_xqsaX_spec_int_t i, p, np; } spec1i;

/* sp_macro front_xqsaX_SPEC_DO_TLOC_MOD_REARRANGE_IP */
#define front_xqsaX_SPEC_DO_TLOC_MOD_REARRANGE_IP(_tl_, _tld_, _b_, _xb_, _ib_)  do { \
  if (_ib_) { \
    for (spec1i.i = 0; spec1i.i < front_xqsaX_spec_elem_get_n(_b_); ++spec1i.i) { \
      spec1i.p = (_tl_)(front_xqsaX_spec_elem_get_buf(_b_), spec1i.i, _tld_, front_xqsaX_spec_elem_get_buf(_ib_)); \
      if (spec1i.p == front_xqsaX_SPEC_LOC_NONE) continue; \
      while (spec1i.i != spec1i.p) { \
        spec1i.np = (_tl_)(front_xqsaX_spec_elem_get_buf(_b_), spec1i.p, _tld_, front_xqsaX_spec_elem_get_buf(_xb_)); \
        if (spec1i.np == front_xqsaX_SPEC_LOC_NONE) break; \
        front_xqsaX_spec_elem_copy_at((_ib_), 0, (_b_), spec1i.p); \
        front_xqsaX_spec_elem_copy_at((_xb_), 0, (_ib_), 0); \
        spec1i.p = spec1i.np; \
      } \
      front_xqsaX_spec_elem_copy_at((_ib_), 0, (_b_), spec1i.i); \
    } \
  } else { \
    for (spec1i.i = 0; spec1i.i < front_xqsaX_spec_elem_get_n(_b_); ++spec1i.i) { \
      spec1i.p = (_tl_)(front_xqsaX_spec_elem_get_buf(_b_), spec1i.i, _tld_, NULL); \
      if (spec1i.p == front_xqsaX_SPEC_LOC_NONE) continue; \
      while (spec1i.i != spec1i.p) { \
        spec1i.np = (_tl_)(front_xqsaX_spec_elem_get_buf(_b_), spec1i.p, _tld_, NULL); \
        if (spec1i.np == front_xqsaX_SPEC_LOC_NONE) { front_xqsaX_spec_elem_copy_at((_b_), spec1i.i, (_b_), spec1i.p); break; } \
        front_xqsaX_spec_elem_exchange_at((_b_), spec1i.i, (_b_), spec1i.p, (_xb_)); \
        spec1i.p = spec1i.np; \
      } \
    } \
 } } while (0) 

/* sp_macro front_xqsaX_SPEC_FUNC_TLOC_MOD_REARRANGE_IP */
#define front_xqsaX_SPEC_FUNC_TLOC_MOD_REARRANGE_IP(_name_, _tl_, _s_) \
_s_ void _name_##_tloc_mod_rearrange_ip(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tloc_data_t tloc_data, front_xqsaX_spec_elem_t *mod) \
{ \
  front_xqsaX_SPEC_DECLARE_TLOC_MOD_REARRANGE_IP \
  front_xqsaX_SPEC_DO_TLOC_MOD_REARRANGE_IP(_tl_, tloc_data, s, x, mod); \
}

/* sp_macro front_xqsaX_SPEC_DEFINE_TLOC */
#define front_xqsaX_SPEC_DEFINE_TLOC(_name_, _tl_, _s_...) \
  front_xqsaX_SPEC_FUNC_TLOC_REARRANGE_DB(_name_, _tl_, _s_) \
  front_xqsaX_SPEC_FUNC_TLOC_REARRANGE_IP(_name_, _tl_, _s_)

/* sp_macro front_xqsaX_SPEC_DEFINE_TLOC_MOD */
#define front_xqsaX_SPEC_DEFINE_TLOC_MOD(_name_, _tl_, _s_...) \
  front_xqsaX_SPEC_FUNC_TLOC_MOD_REARRANGE_DB(_name_, _tl_, _s_) \
  front_xqsaX_SPEC_FUNC_TLOC_MOD_REARRANGE_IP(_name_, _tl_, _s_)

/* sp_macro front_xqsaX_SPEC_EXT_PARAM_TLOC front_xqsaX_SPEC_EXT_PARAM_TLOC_NULL front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL */
#define front_xqsaX_SPEC_EXT_PARAM_TLOC(_name_)      _name_##_tloc_rearrange_db, _name_##_tloc_rearrange_ip
#define front_xqsaX_SPEC_EXT_PARAM_TLOC_NULL         NULL, NULL
#define front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD(_name_)  _name_##_tloc_mod_rearrange_db, _name_##_tloc_mod_rearrange_ip
#define front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL     NULL, NULL


/* sp_type front_xqsaX_spec_tloc_f front_xqsaX_spec_tloc_rearrange_db_f front_xqsaX_spec_tloc_rearrange_ip_f */
typedef front_xqsaX_spec_elem_index_t front_xqsaX_spec_tloc_f(front_xqsaX_spec_elem_buf_t b, front_xqsaX_spec_elem_index_t x, front_xqsaX_spec_tloc_data_t tloc_data);
typedef void front_xqsaX_spec_tloc_rearrange_db_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tloc_data_t tloc_data);
typedef void front_xqsaX_spec_tloc_rearrange_ip_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tloc_data_t tloc_data);

/* sp_type front_xqsaX_spec_tloc_mod_f front_xqsaX_spec_tloc_mod_rearrange_db_f front_xqsaX_spec_tloc_mod_rearrange_ip_f */
typedef front_xqsaX_spec_elem_index_t front_xqsaX_spec_tloc_mod_f(front_xqsaX_spec_elem_buf_t b, front_xqsaX_spec_elem_index_t x, front_xqsaX_spec_tloc_data_t tloc_data, front_xqsaX_spec_elem_buf_t mod);
typedef void front_xqsaX_spec_tloc_mod_rearrange_db_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *d, front_xqsaX_spec_tloc_data_t tloc_data, front_xqsaX_spec_elem_t *mod);
typedef void front_xqsaX_spec_tloc_mod_rearrange_ip_f(front_xqsaX_spec_elem_t *s, front_xqsaX_spec_elem_t *x, front_xqsaX_spec_tloc_data_t tloc_data, front_xqsaX_spec_elem_t *mod);


#endif /* front_xqsaX_SPEC_TLOC */
...
/* sl_type front_xqsaX__permute_generic_t front_xqsaX_permute_generic_t */
typedef struct front_xqsaX__permute_generic_t
{
  int type;

  front_xqsaX_spec_tloc_f *tloc;
  front_xqsaX_spec_tloc_rearrange_db_f *tloc_rearrange_db;
  front_xqsaX_spec_tloc_rearrange_ip_f *tloc_rearrange_ip;

  front_xqsaX_spec_tloc_mod_f *tloc_mod;
  front_xqsaX_spec_tloc_mod_rearrange_db_f *tloc_mod_rearrange_db;
  front_xqsaX_spec_tloc_mod_rearrange_ip_f *tloc_mod_rearrange_ip;

} front_xqsaX_permute_generic_t;

/* sl_macro front_xqsaX_PERMUTE_GENERIC_DEFINE_TLOC front_xqsaX_PERMUTE_GENERIC_INIT_TLOC front_xqsaX_PERMUTE_GENERIC_INIT_EXT_TLOC */
#define front_xqsaX_PERMUTE_GENERIC_DEFINE_TLOC(_tl_, _s_...)      front_xqsaX_SPEC_DEFINE_TLOC(_tl_, _tl_, _s_)
#define front_xqsaX_PERMUTE_GENERIC_INIT_TLOC(_tl_)                { 1, _tl_, front_xqsaX_SPEC_EXT_PARAM_TLOC_NULL,  NULL, front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL }
#define front_xqsaX_PERMUTE_GENERIC_INIT_EXT_TLOC(_tl_)            { 1, _tl_, front_xqsaX_SPEC_EXT_PARAM_TLOC(_tl_), NULL, front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL }

/* sl_macro front_xqsaX_PERMUTE_GENERIC_DEFINE_TLOC_MOD front_xqsaX_PERMUTE_GENERIC_INIT_TLOC_MOD front_xqsaX_PERMUTE_GENERIC_INIT_EXT_TLOC_MOD */
#define front_xqsaX_PERMUTE_GENERIC_DEFINE_TLOC_MOD(_tl_, _s_...)  front_xqsaX_SPEC_DEFINE_TLOC_MOD(_tl_, _tl_, _s_)
#define front_xqsaX_PERMUTE_GENERIC_INIT_TLOC_MOD(_tl_)            { 2, NULL, front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL, _tl_, front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL }
#define front_xqsaX_PERMUTE_GENERIC_INIT_EXT_TLOC_MOD(_tl_)        { 2, NULL, front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD_NULL, _tl_, front_xqsaX_SPEC_EXT_PARAM_TLOC_MOD(_tl_) }

/* sl_type front_xqsaX__split_generic_t front_xqsaX_split_generic_t */
typedef struct front_xqsaX__split_generic_t
{
  int type;

  front_xqsaX_spec_tproc_f *tproc;
  ...
  front_xqsaX_spec_tproc_mod_f *tproc_mod;
  ...
  front_xqsaX_spec_tprocs_f *tprocs;
  ...
  front_xqsaX_spec_tprocs_mod_f *tprocs_mod;
  ...
  front_xqsaX_spec_tproc_reset_f *reset;

} front_xqsaX_split_generic_t;

/* sl_macro front_xqsaX_SPLIT_GENERIC_DEFINE_TPROC front_xqsaX_SPLIT_GENERIC_INIT_TPROC front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROC */
#define front_xqsaX_SPLIT_GENERIC_DEFINE_TPROC(_tp_, _s_...)         front_xqsaX_SPEC_DEFINE_TPROC(_tp_, _tp_, _s_)
#define front_xqsaX_SPLIT_GENERIC_INIT_TPROC(_tp_, _r_...)           { 1, _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL,  NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROC(_tp_, _r_...)       { 1, _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROC(_tp_), NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }

/* sl_macro front_xqsaX_SPLIT_GENERIC_DEFINE_TPROC_MOD front_xqsaX_SPLIT_GENERIC_INIT_TPROC_MOD front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROC_MOD */
#define front_xqsaX_SPLIT_GENERIC_DEFINE_TPROC_MOD(_tp_, _s_...)     front_xqsaX_SPEC_DEFINE_TPROC_MOD(_tp_, _tp_, _s_)
#define front_xqsaX_SPLIT_GENERIC_INIT_TPROC_MOD(_tp_, _r_...)       { 2, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL,  NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROC_MOD(_tp_, _r_...)   { 2, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD(_tp_), NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }

/* sl_macro front_xqsaX_SPLIT_GENERIC_DEFINE_TPROCS front_xqsaX_SPLIT_GENERIC_INIT_TPROCS front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROCS */
#define front_xqsaX_SPLIT_GENERIC_DEFINE_TPROCS(_tp_, _s_...)        front_xqsaX_SPEC_DEFINE_TPROCS(_tp_, _tp_, _s_)
#define front_xqsaX_SPLIT_GENERIC_INIT_TPROCS(_tp_, _r_...)          { 3, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL,  NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROCS(_tp_, _r_...)      { 3, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROCS(_tp_), NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }

/* sl_macro front_xqsaX_SPLIT_GENERIC_DEFINE_TPROCS_MOD front_xqsaX_SPLIT_GENERIC_INIT_TPROCS_MOD front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROCS_MOD */
#define front_xqsaX_SPLIT_GENERIC_DEFINE_TPROCS_MOD(_tp_, _s_...)    front_xqsaX_SPEC_DEFINE_TPROCS_MOD(_tp_, _tp_, _s_)
#define front_xqsaX_SPLIT_GENERIC_INIT_TPROCS_MOD(_tp_, _r_...)      { 4, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL,  _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL,  _r_ }
#define front_xqsaX_SPLIT_GENERIC_INIT_EXT_TPROCS_MOD(_tp_, _r_...)  { 4, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL,  _tp_, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD(_tp_), _r_ }

/* sl_type front_xqsaX_tloc_f front_xqsaX_tloc_mod_f */
typedef front_xqsaX_slint_t front_xqsaX_tloc_f(front_xqsaX_elements_t *b, front_xqsaX_slint_t x, void *tloc_data);
typedef front_xqsaX_slint_t front_xqsaX_tloc_mod_f(front_xqsaX_elements_t *b, front_xqsaX_slint_t x, void *tloc_data, front_xqsaX_elements_t *mod);
...
typedef front_xqsaX_slint_t front_xqsaX_tprocs_f(front_xqsaX_elements_t *b, front_xqsaX_slint_t x, void *tproc_data, int *procs);
typedef front_xqsaX_slint_t front_xqsaX_tprocs_mod_f(front_xqsaX_elements_t *b, front_xqsaX_slint_t x, void *tproc_data, int *procs, front_xqsaX_elements_t *mod);
...
#define front_xqsaX_TPROC_EXDEF_DEFINE_TPROC(_name_, _tp_, _s_...) \
  ...
  _s_ const struct front_xqsaX__tproc_exdef _##_name_ = { 1, front_xqsaX_SPEC_EXT_PARAM_TPROC(_name_), front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define front_xqsaX_TPROC_EXDEF_DEFINE_TPROC_MOD(_name_, _tp_, _s_...) \
  front_xqsaX_SPEC_DEFINE_TPROC_MOD(_name_, _tp_, _s_) \
  _s_ const struct front_xqsaX__tproc_exdef _##_name_ = { 2, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD(_name_), front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define front_xqsaX_TPROC_EXDEF_DEFINE_TPROCS(_name_, _tp_, _s_...) \
  front_xqsaX_SPEC_DEFINE_TPROCS(_name_, _tp_, _s_) \
  _s_ const struct front_xqsaX__tproc_exdef _##_name_ = { 3, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS(_name_), front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define front_xqsaX_TPROC_EXDEF_DEFINE_TPROCS_MOD(_name_, _tp_, _s_...) \
  front_xqsaX_SPEC_DEFINE_TPROCS_MOD(_name_, _tp_, _s_) \
  _s_ const struct front_xqsaX__tproc_exdef _##_name_ = { 4, front_xqsaX_SPEC_EXT_PARAM_TPROC_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROC_MOD_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_NULL, front_xqsaX_SPEC_EXT_PARAM_TPROCS_MOD(_name_) }, *_name_ = &_##_name_;
...
front_xqsaX_slint_t SL_PROTO(front_xqsaX_elements_realloc)(front_xqsaX_elements_t *s, front_xqsaX_slint_t nelements, slcint_t components);
...
front_xqsaX_slint_t SL_PROTO(front_xqsaX_permute_generic_db)(front_xqsaX_elements_t *s, front_xqsaX_elements_t *d, front_xqsaX_permute_generic_t *pg, void *pg_data);
front_xqsaX_slint_t SL_PROTO(front_xqsaX_permute_generic_ip)(front_xqsaX_elements_t *s, front_xqsaX_elements_t *x, front_xqsaX_permute_generic_t *pg, void *pg_data);
...
front_xqsaX_slint_t SL_PROTO(front_xqsaX_split_generic_db)(front_xqsaX_elements_t *s, front_xqsaX_elements_t *d, front_xqsaX_split_generic_t *sg, void *sg_data, front_xqsaX_slint_t n);
front_xqsaX_slint_t SL_PROTO(front_xqsaX_split_generic_ip)(front_xqsaX_elements_t *s, front_xqsaX_elements_t *d, front_xqsaX_split_generic_t *sg, void *sg_data, front_xqsaX_slint_t n);
front_xqsaX_slint_t SL_PROTO(front_xqsaX_split_generic_count_db)(front_xqsaX_elements_t *s, front_xqsaX_split_generic_t *sg, void *sg_data, int *counts, front_xqsaX_slint_t n);
front_xqsaX_slint_t SL_PROTO(front_xqsaX_split_generic_count_ip)(front_xqsaX_elements_t *s, front_xqsaX_split_generic_t *sg, void *sg_data, int *counts, front_xqsaX_slint_t n);
front_xqsaX_slint_t SL_PROTO(front_xqsaX_split_generic_rearrange_db)(front_xqsaX_elements_t *s, front_xqsaX_elements_t *d, front_xqsaX_split_generic_t *sg, void *sg_data, int *counts, front_xqsaX_slint_t n);
front_xqsaX_slint_t SL_PROTO(front_xqsaX_split_generic_rearrange_ip)(front_xqsaX_elements_t *s, front_xqsaX_elements_t *d, front_xqsaX_split_generic_t *sg, void *sg_data, int *counts, int *displs, front_xqsaX_slint_t n);
...
front_xqsaX_slint_t SL_PROTO(front_xqsaX_mpi_elements_alltoallv_proclists_db)(front_xqsaX_elements_t *sbuf, int *scounts, int *sdispls, int nsendprocs, int *sendprocs, front_xqsaX_elements_t *rbuf, int *rcounts, int *rdispls, int nrecvprocs, int *recvprocs, int size, int rank, MPI_Comm comm);
...
front_xqsaX_slint_t SL_PROTO(front_xqsaX_mpi_mergek_sorted2)(front_xqsaX_elements_t *s, front_xqsaX_sortnet_f sn, front_xqsaX_sortnet_data_t snd, front_xqsaX_merge2x_f m2x, front_xqsaX_elements_t *xs, int size, int rank, MPI_Comm comm);
