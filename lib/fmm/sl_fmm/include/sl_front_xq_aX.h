...
#undef front_xq_aX_SL_DATA2                   /* scr */
...
#define front_xq_aX_MC_ALLTOALL_INT_2STEP_THRESHOLD  1024




#if defined(MSEG_ROOT) && !defined(front_xq_aX_MSEG_ROOT)
# define front_xq_aX_MSEG_ROOT  MSEG_ROOT
#endif

#if defined(MSEG_BORDER_UPDATE_REDUCTION) && !defined(front_xq_aX_MSEG_BORDER_UPDATE_REDUCTION)
# define front_xq_aX_MSEG_BORDER_UPDATE_REDUCTION  MSEG_BORDER_UPDATE_REDUCTION
#endif

#if defined(MSEG_DISABLE_BEST_CHOICE) && !defined(front_xq_aX_MSEG_DISABLE_BEST_CHOICE)
# define front_xq_aX_MSEG_DISABLE_BEST_CHOICE  MSEG_DISABLE_BEST_CHOICE
#endif

#if defined(MSEG_DISABLE_MINMAX) && !defined(front_xq_aX_MSEG_DISABLE_MINMAX)
# define front_xq_aX_MSEG_DISABLE_MINMAX  MSEG_DISABLE_MINMAX
#endif

#if defined(MSEG_ENABLE_OPTIMZED_LOWHIGH) && !defined(front_xq_aX_MSEG_ENABLE_OPTIMZED_LOWHIGH)
# define front_xq_aX_MSEG_ENABLE_OPTIMZED_LOWHIGH  MSEG_ENABLE_OPTIMZED_LOWHIGH
#endif

#if defined(MSEG_FORWARD_ONLY) && !defined(front_xq_aX_MSEG_FORWARD_ONLY)
# define front_xq_aX_MSEG_FORWARD_ONLY  MSEG_FORWARD_ONLY
#endif

#if defined(MSEG_INFO) && !defined(front_xq_aX_MSEG_INFO)
# define front_xq_aX_MSEG_INFO  MSEG_INFO
#endif

#if defined(MSEG_TRACE_IF) && !defined(front_xq_aX_MSEG_TRACE_IF)
# define front_xq_aX_MSEG_TRACE_IF  MSEG_TRACE_IF
#endif
...
# define front_xq_aX_sl_weight_type_c             front_xq_aX_sl_int_type_c    /* sl_macro */
# undef front_xq_aX_sl_weight_type_mpi
# define front_xq_aX_sl_weight_type_mpi           front_xq_aX_sl_int_type_mpi  /* sl_macro */
# undef front_xq_aX_sl_weight_size_mpi
# define front_xq_aX_sl_weight_size_mpi           front_xq_aX_sl_int_size_mpi  /* sl_macro */
# undef front_xq_aX_sl_weight_type_fmt
# define front_xq_aX_sl_weight_type_fmt           front_xq_aX_sl_int_type_fmt  /* sl_macro */
# undef front_xq_aX_sl_weight_intequiv
# define front_xq_aX_sl_weight_intequiv                            /* sl_macro */
#else
  /* ... use the given one and check whether an mpi-type is present and required */
# ifdef SL_USE_MPI
...
#  define front_xq_aX_sl_key_val_srand(_s_)                 z_srand(_s_)                                        /* sl_macro */
#  define front_xq_aX_sl_key_val_rand()                     ((front_xq_aX_sl_key_pure_type_c) z_rand())                     /* sl_macro */
#  define front_xq_aX_sl_key_val_rand_minmax(_min_, _max_)  ((front_xq_aX_sl_key_pure_type_c) z_rand_minmax(_min_, _max_))  /* sl_macro */
# endif
#endif
...
/* sl_macro front_xq_aX_FLECKS_GUARD */
/* DATAX_TEMPLATE_BEGIN */
...
#   define front_xq_aX_FLECKS_GUARD
#  endif
# endif
#endif
...
#else
# define front_xq_aX_SPEC_PROC_NONE  -1
#endif

typedef void *front_xq_aX_spec_tloc_data_t;
typedef void *front_xq_aX_spec_tproc_data_t;

struct front_xq_aX__elements_t;

typedef struct front_xq_aX__elements_t *front_xq_aX_spec_elem_buf_t;
...
#define front_xq_aX_spec_elem_set_nmax(_e_, _n_)  front_xq_aX_elem_set_max_size((_e_), (_n_))
#define front_xq_aX_spec_elem_get_nmax(_e_)       front_xq_aX_elem_get_max_size((_e_))

#define front_xq_aX_spec_elem_set_buf(_e_, _b_)   *(_e_) = *(_b_)
#define front_xq_aX_spec_elem_get_buf(_e_)        (_e_)

#define front_xq_aX_spec_elem_copy_at(_se_, _sat_, _de_, _dat_) \
  elem_copy_at((_se_), (_sat_), (_de_), (_dat_))

#define front_xq_aX_spec_elem_exchange_at(_s0_, _s0at_, _s1_, _s1at_, _t_) \
...
/* sp_macro front_xq_aX_SPEC_FUNC_TPROC_COUNT_DB */
#define front_xq_aX_SPEC_FUNC_TPROC_COUNT_DB(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_count_db(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_tproc_data_t tproc_data, int *counts) \
{ \
  front_xq_aX_SPEC_DECLARE_TPROC_COUNT_DB \
  front_xq_aX_SPEC_DO_TPROC_COUNT_DB(_tp_, tproc_data, s, counts); \
}
...
#define front_xq_aX_SPEC_DO_TPROC_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  front_xq_aX_spec_elem_set_n(_b_, spec0ci.t); \
} while (0)

/* sp_macro front_xq_aX_SPEC_FUNC_TPROC_COUNT_IP */
#define front_xq_aX_SPEC_FUNC_TPROC_COUNT_IP(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_count_ip(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_tproc_data_t tproc_data, int *counts) \
{ \
  front_xq_aX_SPEC_DECLARE_TPROC_COUNT_IP \
  front_xq_aX_SPEC_DO_TPROC_COUNT_IP(_tp_, tproc_data, s, counts); \
}
...
/* sp_macro front_xq_aX_SPEC_FUNC_TPROC_MOD_COUNT_DB */
#define front_xq_aX_SPEC_FUNC_TPROC_MOD_COUNT_DB(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_mod_count_db(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_tproc_data_t tproc_data, int *counts) \
{ \
  front_xq_aX_SPEC_DECLARE_TPROC_MOD_COUNT_DB \
  front_xq_aX_SPEC_DO_TPROC_MOD_COUNT_DB(_tp_, tproc_data, s, counts); \
}
...
#define front_xq_aX_SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  front_xq_aX_spec_elem_set_n(_b_, spec1ci.t); \
} while (0)

/* sp_macro front_xq_aX_SPEC_FUNC_TPROC_MOD_COUNT_IP */
#define front_xq_aX_SPEC_FUNC_TPROC_MOD_COUNT_IP(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_mod_count_ip(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_tproc_data_t tproc_data, int *counts) \
{ \
  front_xq_aX_SPEC_DECLARE_TPROC_MOD_COUNT_IP \
  front_xq_aX_SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, tproc_data, s, counts); \
}
...
#define front_xq_aX_SPEC_DO_TPROCS_COUNT_DB(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  for (spec2cd.i = 0; spec2cd.i < front_xq_aX_spec_elem_get_n(_b_); ++spec2cd.i) { \
    spec2cd.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec2cd.i, (_tpd_), (_ps_)); \
...
#define front_xq_aX_SPEC_DO_TPROCS_COUNT_IP(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  spec2ci.t = 0; \
  for (spec2ci.i = 0; spec2ci.i < front_xq_aX_spec_elem_get_n(_b_); ++spec2ci.i) { \
    spec2ci.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec2ci.i, (_tpd_), (_ps_)); \
    if (spec2ci.n <= 0) continue; \
    for (spec2ci.j = 0; spec2ci.j < spec2ci.n; ++spec2ci.j) ++(_cs_)[(_ps_)[spec2ci.j]]; \
    if (spec2ci.t < spec2ci.i) front_xq_aX_spec_elem_copy_at((_b_), spec2ci.i, (_b_), spec2ci.t); \
    ++spec2ci.t; \
  } \
  front_xq_aX_spec_elem_set_n(_b_, spec2ci.t); \
} while (0)
...
#define front_xq_aX_SPEC_DO_TPROCS_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  for (spec3cd.i = 0; spec3cd.i < front_xq_aX_spec_elem_get_n(_b_); ++spec3cd.i) \
  { \
    spec3cd.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec3cd.i, (_tpd_), (_ps_), NULL); \
...
#define front_xq_aX_SPEC_DO_TPROCS_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_, _ps_)  do { \
  spec3ci.t = 0; \
  for (spec3ci.i = 0; spec3ci.i < front_xq_aX_spec_elem_get_n(_b_); ++spec3ci.i) { \
    spec3ci.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec3ci.i, (_tpd_), (_ps_), NULL); \
    if (spec3ci.n <= 0) continue; \
    for (spec3ci.j = 0; spec3ci.j < spec3ci.n; ++spec3ci.j) ++(_cs_)[(_ps_)[spec3ci.j]]; \
    if (spec3ci.t < spec3ci.i) front_xq_aX_spec_elem_copy_at((_b_), spec3ci.i, (_b_), spec3ci.t); \
    ++spec3ci.t; \
  } \
  front_xq_aX_spec_elem_set_n(_b_, spec3ci.t); \
} while (0)
...
/* sp_macro front_xq_aX_SPEC_FUNC_TPROC_REARRANGE_DB */
#define front_xq_aX_SPEC_FUNC_TPROC_REARRANGE_DB(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_rearrange_db(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *d, front_xq_aX_spec_tproc_data_t tproc_data, int *displs) \
{ \
  front_xq_aX_SPEC_DECLARE_TPROC_REARRANGE_DB \
  front_xq_aX_SPEC_DO_TPROC_REARRANGE_DB(_tp_, tproc_data, s, d, displs); \
}
...
#define front_xq_aX_SPEC_DO_TPROC_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_)  do { \
  for (spec0i.e = 0, spec0i.i = 0; spec0i.i < (_n_); ++spec0i.i) { \
    ...
    while (spec0i.j < spec0i.e) { \
      spec0i.p = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec0i.j, _tpd_); \
      while (spec0i.p != spec0i.i) { \
        spec0i.np = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), (_ds_)[spec0i.p], _tpd_); \
        if (spec0i.np != spec0i.p) front_xq_aX_spec_elem_exchange_at((_b_), (_ds_)[spec0i.p], (_b_), spec0i.j, (_xb_)); \
        ++(_ds_)[spec0i.p]; \
        spec0i.p = spec0i.np; \
      } \
      ++spec0i.j; \
...
/* sp_macro front_xq_aX_SPEC_FUNC_TPROC_MOD_REARRANGE_DB */
#define front_xq_aX_SPEC_FUNC_TPROC_MOD_REARRANGE_DB(_name_, _tp_, _s_...) \
_s_ void _name_##_tproc_mod_rearrange_db(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *d, front_xq_aX_spec_tproc_data_t tproc_data, int *displs, front_xq_aX_spec_elem_t *mod) \
{ \
  front_xq_aX_SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  front_xq_aX_SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, tproc_data, s, d, displs, mod); \
}
...
#define front_xq_aX_SPEC_DO_TPROC_MOD_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ib_)  do { \
  if (_ib_) { \
      ...
      while (spec1i.j < spec1i.e) { \
        ...
        while (spec1i.p != spec1i.i) { \
          ...
          if (spec1i.np != spec1i.p) { \
            ...
            front_xq_aX_spec_elem_copy_at((_ib_), 0, (_b_), spec1i.j); \
          } else front_xq_aX_spec_elem_copy_at((_ib_), 0, (_b_), (_ds_)[spec1i.p]); \
          ++(_ds_)[spec1i.p]; \
          spec1i.p = spec1i.np; \
        } \
        ++spec1i.j; \
    ...
    for (spec1i.e = 0, spec1i.i = 0; spec1i.i < (_n_); ++spec1i.i) { \
      ...
      spec1i.j = (_ds_)[spec1i.i]; \
      while (spec1i.j < spec1i.e) { \
        spec1i.p = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec1i.j, _tpd_, NULL); \
        while (spec1i.p != spec1i.i) { \
          spec1i.np = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), (_ds_)[spec1i.p], _tpd_, NULL); \
          if (spec1i.np != spec1i.p) front_xq_aX_spec_elem_exchange_at((_b_), (_ds_)[spec1i.p], (_b_), spec1i.j, (_xb_)); \
          ++(_ds_)[spec1i.p]; \
          spec1i.p = spec1i.np; \
        } \
        ++spec1i.j; \
...
#define front_xq_aX_SPEC_DO_TPROCS_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ps_)  do { \
  for (spec2d.i = 0; spec2d.i < front_xq_aX_spec_elem_get_n(_sb_); ++spec2d.i) { \
    spec2d.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_sb_), spec2d.i, (_tpd_), (_ps_)); \
    for (spec2d.j = 0; spec2d.j < spec2d.n; ++spec2d.j) { \
      front_xq_aX_spec_elem_copy_at((_sb_), spec2d.i, (_db_), (_ds_)[(_ps_)[spec2d.j]]); \
      ++(_ds_)[(_ps_)[spec2d.j]]; \
    } \
  } } while (0)
...
#define front_xq_aX_SPEC_DO_TPROCS_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ps_)  do { \
  spec2i.f = 0; spec2i.fe = (_cs_)[0]; spec2i.fc = front_xq_aX_spec_elem_get_n(_b_); \
  while (spec2i.f + 1 < (_n_) && spec2i.fc >= spec2i.fe) { ++spec2i.f; spec2i.fe += (_cs_)[spec2i.f]; } \
  spec2i.l = 0; spec2i.le = (_cs_)[0]; spec2i.lc = front_xq_aX_spec_elem_get_n(_b_) - 1; \
  ...
  for (spec2i.e = 0, spec2i.i = 0; spec2i.i < (_n_); ++spec2i.i) { \
    ...
    while (spec2i.j < spec2i.e) { \
      spec2i.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec2i.j, (_tpd_), (_ps_)); \
      spec2i.o = -1; \
      while (spec2i.n > 0) { \
        --spec2i.n; \
        if ((_ps_)[spec2i.n] == spec2i.i && spec2i.o < 0) spec2i.o = spec2i.n; \
          ...
          if (spec2i.fc < spec2i.fe) { \
            front_xq_aX_spec_elem_copy_at((_b_), (_ds_)[(_ps_)[spec2i.n]], (_b_), spec2i.fc); \
            ++spec2i.fc; \
          } else front_xq_aX_spec_elem_copy_at((_b_), (_ds_)[(_ps_)[spec2i.n]], (_xb_), 0); \
        } else if ((_ds_)[(_ps_)[spec2i.n]] == spec2i.fc) ++spec2i.fc; \
        if (spec2i.j != (_ds_)[(_ps_)[spec2i.n]]) front_xq_aX_spec_elem_copy_at((_b_), spec2i.j, (_b_), (_ds_)[(_ps_)[spec2i.n]]); \
        ++(_ds_)[(_ps_)[spec2i.n]]; \
        while (spec2i.f + 1 < (_n_) && spec2i.fc >= spec2i.fe) { ++spec2i.f; spec2i.fe += (_cs_)[spec2i.f]; spec2i.fc = (_ds_)[spec2i.f]; } \
      } \
      if (spec2i.o < 0) { \
        if (spec2i.lc < spec2i.le) {  \
          front_xq_aX_spec_elem_copy_at((_b_), spec2i.lc, (_b_), spec2i.j); \
        ...
        } else front_xq_aX_spec_elem_copy_at((_xb_), 0, (_b_), spec2i.j); \
      } \
      spec2i.j = (_ds_)[spec2i.i]; \
    } \
  } } while (0)
...
#define front_xq_aX_SPEC_DO_TPROCS_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ps_, _ib_)  do { \
  if (_ib_) { \
    for (spec3d.i = 0; spec3d.i < front_xq_aX_spec_elem_get_n(_sb_); ++spec3d.i) { \
      spec3d.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_sb_), spec3d.i, (_tpd_), (_ps_), front_xq_aX_spec_elem_get_buf(_ib_)); \
      for (spec3d.j = 0; spec3d.j < spec3d.n; ++spec3d.j) { \
        front_xq_aX_spec_elem_copy_at((_ib_), spec3d.j, (_db_), (_ds_)[(_ps_)[spec3d.j]]); \
        ++(_ds_)[(_ps_)[spec3d.j]]; \
      } \
    } \
  } else { \
    for (spec3d.i = 0; spec3d.i < front_xq_aX_spec_elem_get_n(_sb_); ++spec3d.i) { \
      spec3d.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_sb_), spec3d.i, (_tpd_), (_ps_), NULL); \
      for (spec3d.j = 0; spec3d.j < spec3d.n; ++spec3d.j) { \
        front_xq_aX_spec_elem_copy_at((_sb_), spec3d.i, (_db_), (_ds_)[(_ps_)[spec3d.j]]); \
        ++(_ds_)[(_ps_)[spec3d.j]]; \
      } \
    } \
  } } while (0)
...
#define front_xq_aX_SPEC_DO_TPROCS_MOD_REARRANGE_IP(_tp_, _tpd_, _b_, _xb_, _ds_, _cs_, _n_, _ps_, _ib_)  do { \
  if (_ib_) { \
    spec3i.f = 0; spec3i.fe = (_cs_)[0]; spec3i.fc = front_xq_aX_spec_elem_get_n(_b_); \
    while (spec3i.f + 1 < (_n_) && spec3i.fc >= spec3i.fe) { ++spec3i.f; spec3i.fe += (_cs_)[spec3i.f]; } \
    spec3i.l = 0; spec3i.le = (_cs_)[0]; spec3i.lc = front_xq_aX_spec_elem_get_n(_b_) - 1; \
    ...
    for (spec3i.e = 0, spec3i.i = 0; spec3i.i < (_n_); ++spec3i.i) { \
      ...
      while (spec3i.j < spec3i.e) { \
        spec3i.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec3i.j, (_tpd_), (_ps_), front_xq_aX_spec_elem_get_buf(_ib_)); \
        spec3i.o = -1; \
        while (spec3i.n > 0) { \
          --spec3i.n; \
          if ((_ps_)[spec3i.n] == spec3i.i && spec3i.o < 0) spec3i.o = spec3i.n; \
            ...
            if (spec3i.fc < spec3i.fe) { \
              front_xq_aX_spec_elem_copy_at((_b_), (_ds_)[(_ps_)[spec3i.n]], (_b_), spec3i.fc); \
              ++spec3i.fc; \
            } else front_xq_aX_spec_elem_copy_at((_b_), (_ds_)[(_ps_)[spec3i.n]], (_xb_), 0); \
          } else if ((_ds_)[(_ps_)[spec3i.n]] == spec3i.fc) ++spec3i.fc; \
          front_xq_aX_spec_elem_copy_at((_ib_), spec3i.n, (_b_), (_ds_)[(_ps_)[spec3i.n]]); \
          ++(_ds_)[(_ps_)[spec3i.n]]; \
          while (spec3i.f + 1 < (_n_) && spec3i.fc >= spec3i.fe) { ++spec3i.f; spec3i.fe += (_cs_)[spec3i.f]; spec3i.fc = (_ds_)[spec3i.f]; } \
        } \
        if (spec3i.o < 0) { \
          if (spec3i.lc < spec3i.le) {  \
            front_xq_aX_spec_elem_copy_at((_b_), spec3i.lc, (_b_), spec3i.j); \
          ...
          } else front_xq_aX_spec_elem_copy_at((_xb_), 0, (_b_), spec3i.j); \
        } \
        spec3i.j = (_ds_)[spec3i.i]; \
      } \
    } \
    ...
    for (spec3i.e = 0, spec3i.i = 0; spec3i.i < (_n_); ++spec3i.i) { \
      ...
      spec3i.j = (_ds_)[spec3i.i]; \
      while (spec3i.j < spec3i.e) { \
        spec3i.n = (_tp_)(front_xq_aX_spec_elem_get_buf(_b_), spec3i.j, (_tpd_), (_ps_), NULL); \
        spec3i.o = -1; \
        while (spec3i.n > 0) { \
          --spec3i.n; \
          if ((_ps_)[spec3i.n] == spec3i.i && spec3i.o < 0) spec3i.o = spec3i.n; \
          ...
          if (spec3i.j != (_ds_)[(_ps_)[spec3i.n]]) front_xq_aX_spec_elem_copy_at((_b_), spec3i.j, (_b_), (_ds_)[(_ps_)[spec3i.n]]); \
          ++(_ds_)[(_ps_)[spec3i.n]]; \
          while (spec3i.f + 1 < (_n_) && spec3i.fc >= spec3i.fe) { ++spec3i.f; spec3i.fe += (_cs_)[spec3i.f]; spec3i.fc = (_ds_)[spec3i.f]; } \
        } \
        if (spec3i.o < 0) { \
...
/* sp_macro front_xq_aX_SPEC_DEFINE_TPROC */
#define front_xq_aX_SPEC_DEFINE_TPROC(_name_, _tp_, _s_...) \
  front_xq_aX_SPEC_FUNC_TPROC_COUNT_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROC_COUNT_IP(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROC_REARRANGE_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROC_REARRANGE_IP(_name_, _tp_, _s_)

/* sp_macro front_xq_aX_SPEC_DEFINE_TPROC_MOD */
#define front_xq_aX_SPEC_DEFINE_TPROC_MOD(_name_, _tp_, _s_...) \
  front_xq_aX_SPEC_FUNC_TPROC_MOD_COUNT_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROC_MOD_COUNT_IP(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROC_MOD_REARRANGE_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROC_MOD_REARRANGE_IP(_name_, _tp_, _s_)

/* sp_macro front_xq_aX_SPEC_DEFINE_TPROCS */
#define front_xq_aX_SPEC_DEFINE_TPROCS(_name_, _tp_, _s_...) \
  front_xq_aX_SPEC_FUNC_TPROCS_COUNT_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROCS_COUNT_IP(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROCS_REARRANGE_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROCS_REARRANGE_IP(_name_, _tp_, _s_)

/* sp_macro front_xq_aX_SPEC_DEFINE_TPROCS_MOD */
#define front_xq_aX_SPEC_DEFINE_TPROCS_MOD(_name_, _tp_, _s_...) \
  front_xq_aX_SPEC_FUNC_TPROCS_MOD_COUNT_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROCS_MOD_COUNT_IP(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROCS_MOD_REARRANGE_DB(_name_, _tp_, _s_) \
  front_xq_aX_SPEC_FUNC_TPROCS_MOD_REARRANGE_IP(_name_, _tp_, _s_)

/* sp_macro front_xq_aX_SPEC_EXT_PARAM_TPROC front_xq_aX_SPEC_EXT_PARAM_TPROC_NULL front_xq_aX_SPEC_EXT_PARAM_TPROC_MOD front_xq_aX_SPEC_EXT_PARAM_TPROC_MOD_NULL front_xq_aX_SPEC_EXT_PARAM_TPROCS front_xq_aX_SPEC_EXT_PARAM_TPROCS_NULL front_xq_aX_SPEC_EXT_PARAM_TPROCS_MOD front_xq_aX_SPEC_EXT_PARAM_TPROCS_MOD_NULL */
#define front_xq_aX_SPEC_EXT_PARAM_TPROC(_name_)       _name_##_tproc_count_db, _name_##_tproc_count_ip, _name_##_tproc_rearrange_db, _name_##_tproc_rearrange_ip
#define front_xq_aX_SPEC_EXT_PARAM_TPROC_NULL          NULL, NULL, NULL, NULL
#define front_xq_aX_SPEC_EXT_PARAM_TPROC_MOD(_name_)   _name_##_tproc_mod_count_db, _name_##_tproc_mod_count_ip, _name_##_tproc_mod_rearrange_db, _name_##_tproc_mod_rearrange_ip
#define front_xq_aX_SPEC_EXT_PARAM_TPROC_MOD_NULL      NULL, NULL, NULL, NULL
#define front_xq_aX_SPEC_EXT_PARAM_TPROCS(_name_)      _name_##_tprocs_count_db, _name_##_tprocs_count_ip, _name_##_tprocs_rearrange_db, _name_##_tprocs_rearrange_ip
#define front_xq_aX_SPEC_EXT_PARAM_TPROCS_NULL         NULL, NULL, NULL, NULL
#define front_xq_aX_SPEC_EXT_PARAM_TPROCS_MOD(_name_)  _name_##_tprocs_mod_count_db, _name_##_tprocs_mod_count_ip, _name_##_tprocs_mod_rearrange_db, _name_##_tprocs_mod_rearrange_ip
#define front_xq_aX_SPEC_EXT_PARAM_TPROCS_MOD_NULL     NULL, NULL, NULL, NULL
...
_s_ void _name_##_tloc_rearrange_db(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *d, front_xq_aX_spec_tloc_data_t tloc_data) \
{ \
...
_s_ void _name_##_tloc_rearrange_ip(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *x, front_xq_aX_spec_tloc_data_t tloc_data) \
{ \
...
_s_ void _name_##_tloc_mod_rearrange_db(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *d, front_xq_aX_spec_tloc_data_t tloc_data, front_xq_aX_spec_elem_t *mod) \
{ \
...
_s_ void _name_##_tloc_mod_rearrange_ip(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *x, front_xq_aX_spec_tloc_data_t tloc_data, front_xq_aX_spec_elem_t *mod) \
{ \
...
typedef front_xq_aX_spec_elem_index_t front_xq_aX_spec_tloc_f(front_xq_aX_spec_elem_buf_t b, front_xq_aX_spec_elem_index_t x, front_xq_aX_spec_tloc_data_t tloc_data);
typedef void front_xq_aX_spec_tloc_rearrange_db_f(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *d, front_xq_aX_spec_tloc_data_t tloc_data);
typedef void front_xq_aX_spec_tloc_rearrange_ip_f(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *x, front_xq_aX_spec_tloc_data_t tloc_data);

/* sp_type front_xq_aX_spec_tloc_mod_f front_xq_aX_spec_tloc_mod_rearrange_db_f front_xq_aX_spec_tloc_mod_rearrange_ip_f */
typedef front_xq_aX_spec_elem_index_t front_xq_aX_spec_tloc_mod_f(front_xq_aX_spec_elem_buf_t b, front_xq_aX_spec_elem_index_t x, front_xq_aX_spec_tloc_data_t tloc_data, front_xq_aX_spec_elem_buf_t mod);
typedef void front_xq_aX_spec_tloc_mod_rearrange_db_f(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *d, front_xq_aX_spec_tloc_data_t tloc_data, front_xq_aX_spec_elem_t *mod);
typedef void front_xq_aX_spec_tloc_mod_rearrange_ip_f(front_xq_aX_spec_elem_t *s, front_xq_aX_spec_elem_t *x, front_xq_aX_spec_tloc_data_t tloc_data, front_xq_aX_spec_elem_t *mod);
...
#if defined(front_xq_aX_sl_elem_weight) && defined(front_xq_aX_sl_weight_intequiv)
typedef front_xq_aX_sl_weight_type_c front_xq_aX_slcount_t;       /* sl_type front_xq_aX_slcount_t */
# define front_xq_aX_slcount_fmt  front_xq_aX_sl_weight_type_fmt  /* sl_macro */
#else
typedef front_xq_aX_sl_int_type_c front_xq_aX_slcount_t;
# define front_xq_aX_slcount_fmt  front_xq_aX_sl_int_type_fmt
#endif
...
} const *front_xq_aX_tproc_exdef;

/* sl_macro front_xq_aX_TPROC_EXDEF_NULL */
#define front_xq_aX_TPROC_EXDEF_NULL  NULL
...
#ifdef elem_weight
  front_xq_aX_slweight_t weight_min, weight_max;
  front_xq_aX_slweight_t weight_low, weight_high;
#endif
...
typedef front_xq_aX_slint_t (*front_xq_aX_binning_exec_f)(struct front_xq_aX__binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slcount_t *counts, front_xq_aX_slweight_t *weights);
typedef front_xq_aX_slint_t (*front_xq_aX_binning_refine_f)(struct front_xq_aX__binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slint_t k, front_xq_aX_slcount_t *counts, front_xq_aX_slweight_t *weights, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s, front_xq_aX_bin_t *new_bin);
typedef front_xq_aX_slint_t (*front_xq_aX_binning_hit_f)(struct front_xq_aX__binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slint_t k, front_xq_aX_slcount_t *counts, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s);
typedef front_xq_aX_slint_t (*front_xq_aX_binning_finalize_f)(struct front_xq_aX__binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slint_t dc, front_xq_aX_slweight_t dw, front_xq_aX_slint_t lc_min, front_xq_aX_slint_t lc_max, front_xq_aX_slcount_t *lcs, front_xq_aX_slweight_t *lws, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s);
...
#if defined(elem_weight) && defined(front_xq_aX_sl_weight_intequiv)
  front_xq_aX_slint_t cw_factor, w_index, bin_cw_factor;
  front_xq_aX_slweight_t *cws, *bin_cws;
  front_xq_aX_slweight_t *prefix_cws;
#else
  front_xq_aX_slint_t *cs, *bin_cs;
  front_xq_aX_slint_t *prefix_cs;
# ifdef elem_weight
  front_xq_aX_slweight_t *ws, *bin_ws;
  front_xq_aX_slweight_t *prefix_ws;
# endif
#endif
...
#if defined(elem_weight) && defined(front_xq_aX_sl_weight_intequiv)
  front_xq_aX_slweight_t *cws;
  front_xq_aX_slweight_t *prefix_cws;
#else
  front_xq_aX_slint_t *cs;
  front_xq_aX_slint_t *prefix_cs;
# ifdef elem_weight
  front_xq_aX_slweight_t *ws;
  front_xq_aX_slweight_t *prefix_ws;
# endif
#endif
...
/* sl_type front_xq_aX_rti_cmc_t */
typedef struct
{
  front_xq_aX_slint_t cmp, movek, moved;

} front_xq_aX_rti_cmc_t;
...
/* sl_type front_xq_aX_rti_tim_t */
typedef struct
{
  double start, stop;
  double last, cumu;

  front_xq_aX_slint_t num;

} front_xq_aX_rti_tim_t[rti_tids];
...
/* sl_type front_xq_aX_rti_mem_t */
typedef struct
{
  front_xq_aX_slint_t nalloc, nfree;
  front_xq_aX_slint_t max, cur, cur_max;

} front_xq_aX_rti_mem_t;


/* sl_type front_xq_aX_rti_t */
typedef struct
{
  /* compare-move-counter */
  front_xq_aX_rti_cmc_t cmc;
  /* timer */
  front_xq_aX_rti_tim_t tim;
  /* memory */
  front_xq_aX_rti_mem_t mem;
...
/* sl_type front_xq_aX__sl_context_t front_xq_aX_sl_context_t */
typedef struct front_xq_aX__sl_context_t
{
...
#ifdef front_xq_aX_SL_USE_RTI
front_xq_aX_rti_t rti;
#endif
  struct {
front_xq_aX_slint_t ip_threshold;
front_xq_aX_slint_t db_threshold;
front_xq_aX_slint_t ma_threshold;
  } sr;
  struct {
front_xq_aX_slint_t threshold;
  } sri;
/* src/base_mpi/base_mpi.c */
#ifdef SL_USE_MPI
  struct {
...
front_xq_aX_slint_t sendrecv_replace_memsize;
front_xq_aX_slint_t sendrecv_replace_mpi_maxsize;
  } me;
#endif
#ifdef SL_USE_MPI
  struct {
...
double overalloc;
  ...
  struct {
front_xq_aX_slint_t packed;
front_xq_aX_slint_t db_packed;
front_xq_aX_slint_t ip_packed;
  } mea;
#endif
#ifdef SL_USE_MPI
  struct {
#ifdef front_xq_aX_MSEG_ROOT
int root;
#endif
#ifdef front_xq_aX_MSEG_BORDER_UPDATE_REDUCTION
double border_update_count_reduction;
double border_update_weight_reduction;
#endif
#ifdef front_xq_aX_MSEG_FORWARD_ONLY
front_xq_aX_slint_t forward_only;
#endif
#ifdef front_xq_aX_MSEG_INFO
front_xq_aX_slint_t info_rounds;
front_xq_aX_slint_t *info_finish_rounds;
double info_finish_rounds_avg;
front_xq_aX_slweight_t info_total_weights;
#endif
front_xq_aX_slint_t binnings;
front_xq_aX_slint_t finalize_mode;
  } mseg;
#endif
#ifdef SL_USE_MPI
  struct {
#ifdef front_xq_aX_MSS_ROOT
int root;
#endif
  } mss;
#endif
...
double b_t[3];
front_xq_aX_slint_t sync;
front_xq_aX_slint_t i_sync;
front_xq_aX_slint_t p_sync;
front_xq_aX_slint_t b_sync;
front_xq_aX_slint_t back_packed;
  } mssp;
#endif
} front_xq_aX_sl_context_t;
...
/* DATAX_TEMPLATE_BEGIN */
#define front_xq_aX_elem_set_data0(_e_, _b_)     ((_e_)->data0 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data1(_e_, _b_)     ((_e_)->data1 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data2(_e_, _b_)     ((_e_)->data2 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data3(_e_, _b_)     ((_e_)->data3 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data4(_e_, _b_)     ((_e_)->data4 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data5(_e_, _b_)     ((_e_)->data5 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data6(_e_, _b_)     ((_e_)->data6 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data7(_e_, _b_)     ((_e_)->data7 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data8(_e_, _b_)     ((_e_)->data8 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data9(_e_, _b_)     ((_e_)->data9 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data10(_e_, _b_)     ((_e_)->data10 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data11(_e_, _b_)     ((_e_)->data11 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data12(_e_, _b_)     ((_e_)->data12 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data13(_e_, _b_)     ((_e_)->data13 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data14(_e_, _b_)     ((_e_)->data14 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data15(_e_, _b_)     ((_e_)->data15 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data16(_e_, _b_)     ((_e_)->data16 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data17(_e_, _b_)     ((_e_)->data17 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data18(_e_, _b_)     ((_e_)->data18 = (_b_))  /* sl_macro */
#define front_xq_aX_elem_set_data19(_e_, _b_)     ((_e_)->data19 = (_b_))  /* sl_macro */
/* DATAX_TEMPLATE_END */

/* sl_macro front_xq_aX_elem_get_size front_xq_aX_elem_get_max_size front_xq_aX_elem_get_keys front_xq_aX_elem_get_indices */
#define front_xq_aX_elem_get_size(_e_)           (_e_)->size
#define front_xq_aX_elem_get_max_size(_e_)       (_e_)->max_size
#define front_xq_aX_elem_get_keys(_e_)           (_e_)->keys
#define front_xq_aX_elem_get_indices(_e_)        (_e_)->indices
/* DATAX_TEMPLATE_BEGIN */
#define front_xq_aX_elem_get_data0(_e_)          (_e_)->data0  /* sl_macro */
#define front_xq_aX_elem_get_data1(_e_)          (_e_)->data1  /* sl_macro */
#define front_xq_aX_elem_get_data2(_e_)          (_e_)->data2  /* sl_macro */
#define front_xq_aX_elem_get_data3(_e_)          (_e_)->data3  /* sl_macro */
#define front_xq_aX_elem_get_data4(_e_)          (_e_)->data4  /* sl_macro */
#define front_xq_aX_elem_get_data5(_e_)          (_e_)->data5  /* sl_macro */
#define front_xq_aX_elem_get_data6(_e_)          (_e_)->data6  /* sl_macro */
#define front_xq_aX_elem_get_data7(_e_)          (_e_)->data7  /* sl_macro */
#define front_xq_aX_elem_get_data8(_e_)          (_e_)->data8  /* sl_macro */
#define front_xq_aX_elem_get_data9(_e_)          (_e_)->data9  /* sl_macro */
#define front_xq_aX_elem_get_data10(_e_)          (_e_)->data10  /* sl_macro */
#define front_xq_aX_elem_get_data11(_e_)          (_e_)->data11  /* sl_macro */
#define front_xq_aX_elem_get_data12(_e_)          (_e_)->data12  /* sl_macro */
#define front_xq_aX_elem_get_data13(_e_)          (_e_)->data13  /* sl_macro */
#define front_xq_aX_elem_get_data14(_e_)          (_e_)->data14  /* sl_macro */
#define front_xq_aX_elem_get_data15(_e_)          (_e_)->data15  /* sl_macro */
#define front_xq_aX_elem_get_data16(_e_)          (_e_)->data16  /* sl_macro */
#define front_xq_aX_elem_get_data17(_e_)          (_e_)->data17  /* sl_macro */
#define front_xq_aX_elem_get_data18(_e_)          (_e_)->data18  /* sl_macro */
#define front_xq_aX_elem_get_data19(_e_)          (_e_)->data19  /* sl_macro */
/* DATAX_TEMPLATE_END */

/* sl_macro front_xq_aX_elem_set_block front_xq_aX_elem_set_block_size front_xq_aX_elem_get_block front_xq_aX_elem_get_block_size */
#define front_xq_aX_elem_set_block(_e_, _b_)       ((_e_)->keys = (_b_), (_e_)->max_size = -1)
#define front_xq_aX_elem_set_block_size(_e_, _s_)  ((_e_)->size = (_s_))
#define front_xq_aX_elem_get_block(_e_)            ((void *) (((_e_)->max_size < 0)?(_e_)->keys:NULL))
#define front_xq_aX_elem_get_block_size(_e_)       (_e_)->size
...
/* sl_macro front_xq_aX_pelem_get_size front_xq_aX_pelem_get_max_size front_xq_aX_pelem_get_elements */
#define front_xq_aX_pelem_get_size(_e_)           (_e_)->size
#define front_xq_aX_pelem_get_max_size(_e_)       (_e_)->max_size
#define front_xq_aX_pelem_get_elements(_e_)       (_e_)->elements

/* sl_macro front_xq_aX_SL_DEFCON */
#define front_xq_aX_SL_DEFCON(_v_)  (front_xq_aX_sl_default_context._v_)
...
/* src/base/base.c */
extern front_xq_aX_sl_context_t front_xq_aX_sl_default_context;
extern const int front_xq_aX_default_sl_dummy_rank;
#ifdef front_xq_aX_SL_USE_RTI
extern const front_xq_aX_rti_t front_xq_aX_default_rti;
#endif
extern const front_xq_aX_slint_t front_xq_aX_default_sr_ip_threshold;
extern const front_xq_aX_slint_t front_xq_aX_default_sr_db_threshold;
extern const front_xq_aX_slint_t front_xq_aX_default_sr_ma_threshold;
extern const front_xq_aX_slint_t front_xq_aX_default_sri_threshold;

/* src/base_mpi/base_mpi.c */
#ifdef SL_USE_MPI
extern const MPI_Datatype front_xq_aX_default_mpi_int_datatype;
extern const MPI_Datatype front_xq_aX_default_mpi_key_datatype;
extern const MPI_Datatype front_xq_aX_default_mpi_pkey_datatype;
extern const MPI_Datatype front_xq_aX_default_mpi_pwkey_datatype;
extern const MPI_Datatype front_xq_aX_default_mpi_index_datatype;
extern const MPI_Datatype front_xq_aX_default_mpi_weight_datatype;
extern const MPI_Datatype front_xq_aX_default_mpi_data_datatype[];
extern const int front_xq_aX_default_mpi_rank;
#endif
extern const void *front_xq_aX_default_me_sendrecv_replace_mem;
extern const front_xq_aX_slint_t front_xq_aX_default_me_sendrecv_replace_memsize;
extern const front_xq_aX_slint_t front_xq_aX_default_me_sendrecv_replace_mpi_maxsize;
...
extern const front_xq_aX_slint_t front_xq_aX_default_meas_minalloc;
...
#ifdef front_xq_aX_MSEG_ROOT
extern const int front_xq_aX_default_mseg_root;
#endif
#ifdef front_xq_aX_MSEG_BORDER_UPDATE_REDUCTION
extern const double front_xq_aX_default_mseg_border_update_count_reduction;
extern const double front_xq_aX_default_mseg_border_update_weight_reduction;
#endif
#ifdef front_xq_aX_MSEG_FORWARD_ONLY
extern const front_xq_aX_slint_t front_xq_aX_default_mseg_forward_only;
#endif
#ifdef front_xq_aX_MSEG_INFO
extern const front_xq_aX_slint_t front_xq_aX_default_mseg_info_rounds;
extern const front_xq_aX_slint_t *front_xq_aX_default_mseg_info_finish_rounds;
extern const double front_xq_aX_default_mseg_info_finish_rounds_avg;
extern const front_xq_aX_slweight_t front_xq_aX_default_mseg_info_total_weights;
#endif
extern const front_xq_aX_slint_t front_xq_aX_default_mseg_binnings;
extern const front_xq_aX_slint_t front_xq_aX_default_mseg_finalize_mode;
#ifdef front_xq_aX_MSS_ROOT
extern const int front_xq_aX_default_mss_root;
#endif
extern const double front_xq_aX_default_msm_t[];
extern const front_xq_aX_slint_t front_xq_aX_default_msm_sync;
extern const double front_xq_aX_default_msp_t[];
extern const front_xq_aX_slint_t front_xq_aX_default_msp_sync;
extern const front_xq_aX_partcond_t *front_xq_aX_default_msp_r_pc;
extern const double front_xq_aX_default_mssp_i_t[];
extern const double front_xq_aX_default_mssp_p_t[];
extern const double front_xq_aX_default_mssp_b_t[];
extern const front_xq_aX_slint_t front_xq_aX_default_mssp_sync;
extern const front_xq_aX_slint_t front_xq_aX_default_mssp_i_sync;
extern const front_xq_aX_slint_t front_xq_aX_default_mssp_p_sync;
extern const front_xq_aX_slint_t front_xq_aX_default_mssp_b_sync;
extern const front_xq_aX_slint_t front_xq_aX_default_mssp_back_packed;
...
/* src/base/base.c */
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_create)(front_xq_aX_local_bins_t *lb, front_xq_aX_slint_t max_nbins, front_xq_aX_slint_t max_nbinnings, front_xq_aX_elements_t *s, front_xq_aX_slint_t nelements, front_xq_aX_slint_t docounts, front_xq_aX_slint_t doweights, front_xq_aX_binning_t *bm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_exec_reset)(front_xq_aX_local_bins_t *lb, front_xq_aX_slint_t do_bins, front_xq_aX_slint_t do_prefixes);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_exec)(front_xq_aX_local_bins_t *lb, front_xq_aX_slint_t b, front_xq_aX_slint_t do_bins, front_xq_aX_slint_t do_prefixes);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_finalize)(front_xq_aX_local_bins_t *lb, front_xq_aX_slint_t b, front_xq_aX_slint_t dc, front_xq_aX_slweight_t dw, front_xq_aX_slint_t lc_min, front_xq_aX_slint_t lc_max, front_xq_aX_slcount_t *lcs, front_xq_aX_slweight_t *lws, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_radix_exec)(front_xq_aX_binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slcount_t *counts, front_xq_aX_slweight_t *weights);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_radix_refine)(front_xq_aX_binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slint_t k, front_xq_aX_slcount_t *counts, front_xq_aX_slweight_t *weights, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s, front_xq_aX_bin_t *new_bin);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_radix_hit)(front_xq_aX_binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slint_t k, front_xq_aX_slcount_t *counts, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_binning_radix_finalize)(front_xq_aX_binning_t *bm, front_xq_aX_bin_t *bin, front_xq_aX_slint_t dc, front_xq_aX_slweight_t dw, front_xq_aX_slint_t lc_min, front_xq_aX_slint_t lc_max, front_xq_aX_slcount_t *lcs, front_xq_aX_slweight_t *lws, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_alloc_from_block)(front_xq_aX_elements_t *s, void *block, front_xq_aX_slint_t blocksize, front_xq_aX_slint_t alignment, front_xq_aX_slint_t nmax, slcint_t components);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_alloc_block)(front_xq_aX_elements_t *s, void **block, front_xq_aX_slint_t *blocksize, front_xq_aX_slint_t alignment, front_xq_aX_slint_t maxblocksize);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_digest_sum)(front_xq_aX_elements_t *s, front_xq_aX_slint_t nelements, slcint_t components, unsigned int *sum);
unsigned int SL_PROTO(front_xq_aX_elements_crc32)(front_xq_aX_elements_t *s, front_xq_aX_slint nelements, front_xq_aX_slint_t keys, front_xq_aX_slint_t data);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_digest_hash)(front_xq_aX_elements_t *s, front_xq_aX_slint_t nelements, slcint_t components, void *hash);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_keys_init_seed)(unsigned long s);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_keys_init_randomized)(front_xq_aX_elements_t *s, front_xq_aX_slint_t nkeys, front_xq_aX_keys_init_type_t t, front_xq_aX_keys_init_data_t d);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_keys_init_from_file)(front_xq_aX_elements_t *s, front_xq_aX_slint_t data, char *filename, front_xq_aX_slint_t from, front_xq_aX_slint_t to, front_xq_aX_slint_t const_bytes_per_line);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_keys_save_to_file)(front_xq_aX_elements_t *s, char *filename);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_keys_stats_print)(front_xq_aX_elements_t *s);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_alloc_packed_from_block)(front_xq_aX_packed_elements_t *s, void *block, front_xq_aX_slint_t blocksize, front_xq_aX_slint_t alignment, front_xq_aX_slint_t nmax);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_pack_at)(front_xq_aX_elements_t *s, front_xq_aX_slint_t sat, front_xq_aX_packed_elements_t *d, front_xq_aX_slint_t dat);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elements_unpack_at)(front_xq_aX_packed_elements_t *s, front_xq_aX_slint_t sat, front_xq_aX_elements_t *d, front_xq_aX_slint_t dat);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_compo_hula)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *xs);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sseq_x0_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sseq_0x_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sseq_01_x)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sseq_01)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sbin_x0_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sbin_0x_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sbin_01_x)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_sbin_01)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_shyb_x0_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_shyb_0x_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_shyb_01_x)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_shyb_01)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_x0_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_0x_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_01_x)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_x_0_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_X0_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_0X_1)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_01_X)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_basic_straight_X0_1u)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx, front_xq_aX_elements_t *t);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_merge2_compo_tridgell)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *sx);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mergep_2way_ip_int_rec)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, front_xq_aX_slint_t p, int *displs, front_xq_aX_merge2x_f m2x);
...
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_sequential_ge)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_sequential_lt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_sequential_le)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_sequential_gt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_sequential_ge)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_binary_lt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_binary_le)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_binary_gt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_binary_ge)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_binary_lt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_binary_le)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_binary_gt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_binary_ge)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_sl_search_binary_lt_bmask)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k, front_xq_aX_slpkey_t bmask);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_sl_search_binary_le_bmask)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k, front_xq_aX_slpkey_t bmask);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_sl_search_binary_sign_switch)(front_xq_aX_elements_t *s);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_hybrid_lt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_hybrid_le)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_hybrid_gt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_hybrid_ge)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_hybrid_lt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_hybrid_le)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_hybrid_gt)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k, front_xq_aX_slint t);
front_xq_aX_slint SL_PROTO(front_xq_aX_sl_search_p_hybrid_ge)(front_xq_aX_elements_t *s, front_xq_aX_slpkey_t *k, front_xq_aX_slint t);
...
void SL_PROTO(front_xq_aX_get_displcounts_extent)(front_xq_aX_slint_t n, int *displs, int *counts, front_xq_aX_slint_t *lb, front_xq_aX_slint_t *extent);
void SL_PROTO(front_xq_aX_elem_set_data)(front_xq_aX_elements_t *e, ...);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_elem_get_max_byte)();
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_sort_permute_forward)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, front_xq_aX_slint_t *perm, front_xq_aX_slint_t offset, front_xq_aX_slint_t mask_bit);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_sort_permute_backward)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, front_xq_aX_slint_t *perm, front_xq_aX_slint_t offset, front_xq_aX_slint_t mask_bit);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_sort_radix_iter)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, front_xq_aX_slint_t presorted, front_xq_aX_slint_t rhigh, front_xq_aX_slint_t rlow, front_xq_aX_slint_t rwidth);
...
/* src/base_mpi/base_mpi.c */
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_binning_create)(front_xq_aX_global_bins_t *gb, front_xq_aX_slint_t max_nbins, front_xq_aX_slint_t max_nbinnings, front_xq_aX_elements_t *s, front_xq_aX_slint_t nelements, front_xq_aX_slint_t docounts, front_xq_aX_slint_t doweights, front_xq_aX_binning_t *bm, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_binning_exec_reset)(front_xq_aX_global_bins_t *gb, front_xq_aX_slint_t do_bins, front_xq_aX_slint_t do_prefixes, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_binning_exec_local)(front_xq_aX_global_bins_t *gb, front_xq_aX_slint_t b, front_xq_aX_slint_t do_bins, front_xq_aX_slint_t do_prefixes, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_binning_exec_global)(front_xq_aX_global_bins_t *gb, front_xq_aX_slint_t do_bins, front_xq_aX_slint_t do_prefixes, front_xq_aX_slint_t root, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_binning_finalize)(front_xq_aX_global_bins_t *gb, front_xq_aX_slint_t b, front_xq_aX_slint_t dc, front_xq_aX_slweight_t dw, front_xq_aX_slint_t lc_min, front_xq_aX_slint_t lc_max, front_xq_aX_slcount_t *lcs, front_xq_aX_slweight_t *lws, front_xq_aX_splitter_t *sp, front_xq_aX_slint_t s, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_get_grid_properties)(front_xq_aX_slint_t ndims, front_xq_aX_slint_t *dims, front_xq_aX_slint_t *pos, int size, int rank, MPI_Comm comm);
...
int SL_PROTO(front_xq_aX_sl_MPI_Allreduce)(void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, int size, int rank);
int SL_PROTO(front_xq_aX_sl_MPI_Alltoall_int)(void *sendbuf, int sendcount, void *recvbuf, int recvcount, MPI_Comm comm, int size, int rank);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_keys_init_from_file)(front_xq_aX_elements_t *s, char *filename, front_xq_aX_slint from, front_xq_aX_slint to, front_xq_aX_slint const_bytes_per_line, front_xq_aX_slint root, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_digest_sum)(front_xq_aX_elements_t *s, front_xq_aX_slint_t nelements, slcint_t components, unsigned int *sum, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_digest_hash)(front_xq_aX_elements_t *s, front_xq_aX_slint_t nelements, slcint_t components, void *hash, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_create_tproc)(front_xq_aX_tproc_t *tproc, front_xq_aX_tproc_f *tfn, front_xq_aX_tproc_reset_f *rfn, front_xq_aX_tproc_exdef exdef);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_create_tproc_mod)(front_xq_aX_tproc_t *tproc, front_xq_aX_tproc_mod_f *tfn, front_xq_aX_tproc_reset_f *rfn, front_xq_aX_tproc_exdef exdef);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_create_tprocs)(front_xq_aX_tproc_t *tproc, front_xq_aX_tprocs_f *tfn, front_xq_aX_tproc_reset_f *rfn, front_xq_aX_tproc_exdef exdef);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_create_tprocs_mod)(front_xq_aX_tproc_t *tproc, front_xq_aX_tprocs_mod_f *tfn, front_xq_aX_tproc_reset_f *rfn, front_xq_aX_tproc_exdef exdef);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_free)(front_xq_aX_tproc_t *tproc);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_set_proclists)(front_xq_aX_tproc_t *tproc, front_xq_aX_slint_t nsend_procs, int *send_procs, front_xq_aX_slint_t nrecv_procs, int *recv_procs, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_tproc_verify)(front_xq_aX_tproc_t tproc, void *data, front_xq_aX_elements_t *s, int proc);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoall_specific)(front_xq_aX_elements_t *sin, front_xq_aX_elements_t *sout, front_xq_aX_elements_t *xs, front_xq_aX_tproc_t tproc, void *data, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_db_packed)(front_xq_aX_elements_t *sbuf, int *scounts, int *sdispls, front_xq_aX_elements_t *rbuf, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_ip_packed)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, int *scounts, int *sdispls, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_ip_double)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, int *scounts, int *sdispls, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_ip_mpi)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, int *scounts, int *sdispls, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_ip_dash)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, int *scounts, int *sdispls, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_ip)(front_xq_aX_elements_t *s, front_xq_aX_elements_t *sx, int *scounts, int *sdispls, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_elements_alltoallv_proclists_db)(front_xq_aX_elements_t *sbuf, int *scounts, int *sdispls, int nsendprocs, int *sendprocs, front_xq_aX_elements_t *rbuf, int *rcounts, int *rdispls, int nrecvprocs, int *recvprocs, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_mergek_sorted)(front_xq_aX_elements_t *s, front_xq_aX_merge2x_f m2x, front_xq_aX_elements_t *xs, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_mergek_sorted2)(front_xq_aX_elements_t *s, front_xq_aX_sortnet_f sn, front_xq_aX_sortnet_data_t snd, front_xq_aX_merge2x_f m2x, front_xq_aX_elements_t *xs, int size, int rank, MPI_Comm comm);
...
void SL_PROTO(front_xq_aX_mpi_partcond_set_even)(front_xq_aX_partcond_t *pcond, front_xq_aX_slint_t pcm, front_xq_aX_slint_t ntotal, double nimba, double wtotal, double wimba, int size, int rank);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_sort_merge_radix)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *xs, front_xq_aX_slint_t merge_type, front_xq_aX_slint_t sort_type, front_xq_aX_slint_t rhigh, front_xq_aX_slint_t rlow, front_xq_aX_slint_t rwidth, int size, int rank, MPI_Comm comm);
...
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_sort_insert_radix)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *xs, front_xq_aX_slpkey_t *mmkeys, front_xq_aX_slint_t rhigh, front_xq_aX_slint_t rlow, front_xq_aX_slint_t rwidth, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_sort_presorted_radix)(front_xq_aX_elements_t *s0, front_xq_aX_elements_t *s1, front_xq_aX_elements_t *xs, front_xq_aX_slint_t merge_type, front_xq_aX_slint_t rhigh, front_xq_aX_slint_t rlow, front_xq_aX_slint_t rwidth, int size, int rank, MPI_Comm comm);
front_xq_aX_slint_t SL_PROTO(front_xq_aX_mpi_sort_back)(front_xq_aX_elements_t *sin, front_xq_aX_elements_t *sout, front_xq_aX_elements_t *sx, front_xq_aX_slpkey_t *lh, front_xq_aX_slint_t ntotal, int size, int rank, MPI_Comm comm);
