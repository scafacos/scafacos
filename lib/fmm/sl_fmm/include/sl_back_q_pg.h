...
typedef back_q_pg_sl_int_type_c back_q_pg_spint_t;

typedef back_q_pg_spint_t back_q_pg_spec_elem_index_t;
...
#define back_q_pg_SPEC_PROC_NULL  MPI_PROC_NULL
...
/* sp_macro back_q_pg_SPEC_PROC_NULL */
...
#define back_q_pg_SPEC_DECLARE_TPROC_COUNT_DB \
  struct { back_q_pg_spint_t i, p; } spec0cd;
...
#define back_q_pg_SPEC_DO_TPROC_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec0cd.i = 0; spec0cd.i < back_q_pg_spec_elem_get_n(_b_); ++spec0cd.i) { \
    ...
    if (spec0cd.p == back_q_pg_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec0cd.p]; \
  } } while (0)
...
#define back_q_pg_SPEC_DECLARE_TPROC_COUNT_IP \
  struct { back_q_pg_spint_t i, p, t; } spec0ci;
...
#define back_q_pg_SPEC_DO_TPROC_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec0ci.i = 0; spec0ci.i < back_q_pg_spec_elem_get_n(_b_); ++spec0ci.i) { \
    ...
    if (spec0ci.p == back_q_pg_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec0ci.p]; \
...
#define back_q_pg_SPEC_DECLARE_TPROC_MOD_COUNT_DB \
  struct { back_q_pg_spint_t i, p; } spec1cd;
...
#define back_q_pg_SPEC_DO_TPROC_MOD_COUNT_DB(_tp_, _tpd_, _b_, _cs_)  do { \
  for (spec1cd.i = 0; spec1cd.i < back_q_pg_spec_elem_get_n(_b_); ++spec1cd.i) { \
    ...
    if (spec1cd.p == back_q_pg_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec1cd.p]; \
  } } while (0)
...
#define back_q_pg_SPEC_DECLARE_TPROC_MOD_COUNT_IP \
  struct { back_q_pg_spint_t i, p, t; } spec1ci;
...
#define back_q_pg_SPEC_DO_TPROC_MOD_COUNT_IP(_tp_, _tpd_, _b_, _cs_)  do { \
  ...
  for (spec1ci.i = 0; spec1ci.i < back_q_pg_spec_elem_get_n(_b_); ++spec1ci.i) { \
    ...
    if (spec1ci.p == back_q_pg_SPEC_PROC_NULL) continue; \
    ++(_cs_)[spec1ci.p]; \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_COUNT_DB \
  struct { back_q_pg_spint_t i, j, n; } spec2cd;
...
_s_ void _name_##_tprocs_count_db(back_q_pg_spec_elem_t *s, back_q_pg_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_COUNT_IP \
  struct { back_q_pg_spint_t i, j, n, t; } spec2ci;
...
_s_ void _name_##_tprocs_count_ip(back_q_pg_spec_elem_t *s, back_q_pg_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_MOD_COUNT_DB \
  struct { back_q_pg_spint_t i, j, n; } spec3cd;
...
_s_ void _name_##_tprocs_mod_count_db(back_q_pg_spec_elem_t *s, back_q_pg_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_MOD_COUNT_IP \
  struct { back_q_pg_spint_t i, j, n, t; } spec3ci;
...
_s_ void _name_##_tprocs_mod_count_ip(back_q_pg_spec_elem_t *s, back_q_pg_spec_tproc_data_t tproc_data, int *counts, int *procs) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROC_REARRANGE_DB \
  struct { back_q_pg_spint_t i, p; } spec0d;
...
#define back_q_pg_SPEC_DO_TPROC_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_)  do { \
  for (spec0d.i = 0; spec0d.i < back_q_pg_spec_elem_get_n(_sb_); ++spec0d.i) { \
    ...
    if (spec0d.p == back_q_pg_SPEC_PROC_NULL) continue; \
...
#define back_q_pg_SPEC_DECLARE_TPROC_REARRANGE_IP \
  struct { back_q_pg_spint_t e, i, j, p, np; } spec0i;
...
_s_ void _name_##_tproc_rearrange_ip(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROC_MOD_REARRANGE_DB \
  struct { back_q_pg_spint_t i, p; } spec1d;
...
#define back_q_pg_SPEC_DO_TPROC_MOD_REARRANGE_DB(_tp_, _tpd_, _sb_, _db_, _ds_, _ib_)  do { \
  if (_ib_) { \
    for (spec1d.i = 0; spec1d.i < back_q_pg_spec_elem_get_n(_sb_); ++spec1d.i) { \
      ...
      if (spec1d.p == back_q_pg_SPEC_PROC_NULL) continue; \
...
#define back_q_pg_SPEC_DECLARE_TPROC_MOD_REARRANGE_IP \
  struct { back_q_pg_spint_t e, i, j, p, np; } spec1i;
    ...
    for (spec1i.e = 0, spec1i.i = 0; spec1i.i < (_n_); ++spec1i.i) { \
      ...
      while (spec1i.j < spec1i.e) { \
        ...
        while (spec1i.p != spec1i.i) { \
          spec1i.np = (_tp_)(back_q_pg_spec_elem_get_buf(_b_), (_ds_)[spec1i.p], _tpd_, (_ib_)); \
...
_s_ void _name_##_tproc_mod_rearrange_ip(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, back_q_pg_spec_elem_t *mod) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_REARRANGE_DB \
  struct { back_q_pg_spint_t i, j, n; } spec2d;
...
_s_ void _name_##_tprocs_rearrange_db(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *d, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *procs) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_REARRANGE_IP \
  struct { back_q_pg_spint_t e, i, j, n, f, fe, fc, l, le, lc, o; } spec2i;
...
_s_ void _name_##_tprocs_rearrange_ip(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *d, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_MOD_REARRANGE_DB \
  struct { back_q_pg_spint_t i, j, n; } spec3d;
...
_s_ void _name_##_tprocs_mod_rearrange_db(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *d, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *procs, back_q_pg_spec_elem_t *mod) \
{ \
...
#define back_q_pg_SPEC_DECLARE_TPROCS_MOD_REARRANGE_IP \
  struct { back_q_pg_spint_t e, i, j, n, o, f, fe, fc, l, le, lc; } spec3i;
...
_s_ void _name_##_tprocs_mod_rearrange_ip(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs, back_q_pg_spec_elem_t *mod) \
{ \
...
typedef int back_q_pg_spec_tproc_f(back_q_pg_spec_elem_buf_t b, back_q_pg_spec_elem_index_t x, back_q_pg_spec_tproc_data_t tproc_data);
...
typedef void back_q_pg_spec_tproc_rearrange_ip_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n);
...
typedef int back_q_pg_spec_tproc_mod_f(back_q_pg_spec_elem_buf_t b, back_q_pg_spec_elem_index_t x, back_q_pg_spec_tproc_data_t tproc_data, back_q_pg_spec_elem_buf_t mod);
...
typedef void back_q_pg_spec_tproc_mod_rearrange_ip_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, back_q_pg_spec_elem_t *mod);
...
typedef int back_q_pg_spec_tprocs_f(back_q_pg_spec_elem_buf_t b, back_q_pg_spec_elem_index_t x, back_q_pg_spec_tproc_data_t tproc_data, int *procs);
typedef void back_q_pg_spec_tprocs_count_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_tproc_data_t tproc_data, int *procs, int *counts);
typedef void back_q_pg_spec_tprocs_rearrange_db_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *d, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *procs);
typedef void back_q_pg_spec_tprocs_rearrange_ip_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs);
...
typedef int back_q_pg_spec_tprocs_mod_f(back_q_pg_spec_elem_buf_t b, back_q_pg_spec_elem_index_t x, back_q_pg_spec_tproc_data_t tproc_data, int *procs, back_q_pg_spec_elem_buf_t mod);
typedef void back_q_pg_spec_tprocs_mod_count_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_tproc_data_t tproc_data, int *procs, int *counts);
typedef void back_q_pg_spec_tprocs_mod_rearrange_db_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *d, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *procs, back_q_pg_spec_elem_t *mod);
typedef void back_q_pg_spec_tprocs_mod_rearrange_ip_f(back_q_pg_spec_elem_t *s, back_q_pg_spec_elem_t *x, back_q_pg_spec_tproc_data_t tproc_data, int *displs, int *counts, int n, int *procs, back_q_pg_spec_elem_t *mod);
...
typedef int back_q_pg_tprocs_f(back_q_pg_elements_t *b, back_q_pg_slint_t x, void *tproc_data, int *procs);
typedef int back_q_pg_tprocs_mod_f(back_q_pg_elements_t *b, back_q_pg_slint_t x, void *tproc_data, int *procs, back_q_pg_elements_t *mod);
...
#define back_q_pg_TPROC_EXDEF_DEFINE_TPROC(_name_, _tp_, _s_...) \
  ...
  const struct back_q_pg__tproc_exdef _##_name_ = { 1, back_q_pg_SPEC_EXT_PARAM_TPROC(_name_), back_q_pg_SPEC_EXT_PARAM_TPROC_MOD_NULL, back_q_pg_SPEC_EXT_PARAM_TPROCS_NULL, back_q_pg_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define back_q_pg_TPROC_EXDEF_DEFINE_TPROC_MOD(_name_, _tp_, _s_...) \
  back_q_pg_SPEC_DEFINE_TPROC_MOD(_name_, _tp_, _s_) \
  const struct back_q_pg__tproc_exdef _##_name_ = { 2, back_q_pg_SPEC_EXT_PARAM_TPROC_NULL, back_q_pg_SPEC_EXT_PARAM_TPROC_MOD(_name_), back_q_pg_SPEC_EXT_PARAM_TPROCS_NULL, back_q_pg_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define back_q_pg_TPROC_EXDEF_DEFINE_TPROCS(_name_, _tp_, _s_...) \
  back_q_pg_SPEC_DEFINE_TPROCS(_name_, _tp_, _s_) \
  const struct back_q_pg__tproc_exdef _##_name_ = { 3, back_q_pg_SPEC_EXT_PARAM_TPROC_NULL, back_q_pg_SPEC_EXT_PARAM_TPROC_MOD_NULL, back_q_pg_SPEC_EXT_PARAM_TPROCS(_name_), back_q_pg_SPEC_EXT_PARAM_TPROCS_MOD_NULL }, *_name_ = &_##_name_;

#define back_q_pg_TPROC_EXDEF_DEFINE_TPROCS_MOD(_name_, _tp_, _s_...) \
  back_q_pg_SPEC_DEFINE_TPROCS_MOD(_name_, _tp_, _s_) \
  const struct back_q_pg__tproc_exdef _##_name_ = { 4, back_q_pg_SPEC_EXT_PARAM_TPROC_NULL, back_q_pg_SPEC_EXT_PARAM_TPROC_MOD_NULL, back_q_pg_SPEC_EXT_PARAM_TPROCS_NULL, back_q_pg_SPEC_EXT_PARAM_TPROCS_MOD(_name_) }, *_name_ = &_##_name_;
...
back_q_pg_slint_t SL_PROTO(back_q_pg_split_generic_count)(back_q_pg_elements_t *s, back_q_pg_tproc_f tp, void *tp_data, int *counts);
back_q_pg_slint_t SL_PROTO(back_q_pg_split_generic_rearrange_ip)(back_q_pg_elements_t *s, back_q_pg_elements_t *sx, back_q_pg_tproc_f tp, void *tp_data, int *displs, int *counts, int n);
