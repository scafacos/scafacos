...
void armci_vapi_complete_buf(armci_vapi_field_t *field,int snd,int rcv,int to,int op); /* remove warnings (M. Hofmann) */
...
void armci_vapi_test_buf(armci_vapi_field_t *field,int snd,int rcv,int to,int op, int *retval); /* remove warnings (M. Hofmann) */
