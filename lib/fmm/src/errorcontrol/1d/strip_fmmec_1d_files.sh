...
grep " = 0" fmm1p.f | colrm 1 15 | colrm 26 1000 > fmmec_1d_consts.h
...
do
 ...
 sed -n ${CUT_S},${CUT_E}p fmmec_1d_consts.h | sed '''s/$/,/' | sed '''$s/,//' > include/fmmec_1d_p${FILECOUNTER}.h
 CUT_S=$((CUT_E+1))
 CUT_L=$((CUT_L+969))
 CUT_E=$((CUT_E+CUT_L))
