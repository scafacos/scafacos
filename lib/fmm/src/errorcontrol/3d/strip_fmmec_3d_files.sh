...
grep " = 0" fmm3p.f | colrm 1 15 | colrm 26 1000 > fmmec_3d_consts.h
...
do
 ...
 sed -n ${CUT_S},${CUT_E}p fmmec_3d_consts.h | sed '''s/$/,/' | sed '''$s/,//' > include/fmmec_3d_p${FILECOUNTER}.h
 CUT_S=$((CUT_E+1))
 CUT_L=$((CUT_L+969))
 CUT_E=$((CUT_E+CUT_L))
