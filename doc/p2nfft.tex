...
\begin{itemize}
  ...
  \item \verb!p2nfft_reg_far! -
    ...
    Feasible values are $0$ (Fourier coefficients have been precomputed via CG iteration, only available for some sets of parameters and only available in combination with the same flag for near field regularization),
  ...
  \item \verb!p2nfft_reg_far_name! (alternative: \verb!p2nfft_reg_far!) -
    ...
    \verb!rad_t2p_mir_ec! (radial regularization with mirrored two-point Taylor polynomial and explicitly chosen constant continuation value),
    \verb!rad_t2p_mir_ic! (radial regularization with mirrored two-point Taylor polynomial and implicitly chosen constant continuation value),
    \verb!rec_t2p_sym!    (radial regularization with symmetric two-point Taylor polynomial),
    \verb!rec_t2p_mir_ec! (radial regularization with mirrored two-point Taylor polynomial and explicitly chosen constant continuation value), and
    \verb!rec_t2p_mir_ic! (radial regularization with mirrored two-point Taylor polynomial and implicitly chosen constant continuation value).
    Default value is \verb!rad_t2p_mir_ic!.
  \item \verb!p2nfft_c! -
    The constant continuation value of the far field regularization. This parameter only takes affect, if far field regularization \verb!rad_t2p_mir_ec! or \verb!rec_t2p_mir_ec! is enabled.
