...
\begin{itemize}
  ...
  \item \verb!p2nfft_reg! -
    Choose between the two regularization methods for non-periodic boundaries. Feasible values are \verb!taylor2p! (Regularization with 2-point-Taylor polynomials)
